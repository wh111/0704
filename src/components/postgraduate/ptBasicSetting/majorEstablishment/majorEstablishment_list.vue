...
----------------------------------->
<!----------------------------------
****--专业管理_列表(ptMajorManagement_list)
****--@date     2017/9/9
        ...
        <div class="listUpArea-searchWrapper">
          ...
          <el-form ref="formValidate" :inline="true" :model="formValidate" class="form-inline lose-margin"
            ...
            <div class="listUpArea-searchLeft">
              <input class="hidden">
              <el-input placeholder="请输入内容" v-model="formValidate.major">
                <div slot="prepend">专业名称</div>
...
<script>
  ...
  //引入--查看--组件
  import show from "./majorEstablishment_view.vue";
  //引入--添加--组件
  import addOrEdit from "./majorEstablishment_addOrEdit.vue";
  //引入--修改--组件
  import edit from "./majorEstablishment_edit.vue";
  //当前组件引入全局的util
  let Util = null;
  ...
  export default {
    data() {
      return {
        //查询表单
        deleteUrl: api.ptMajorRemoves.path,
        formValidate: {
          "major": "",
          "major_code":""
        },
