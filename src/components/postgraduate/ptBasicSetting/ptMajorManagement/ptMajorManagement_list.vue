...
<script >
  ...
  //引入--修改--组件
  import edit from "./ptMajorManagement_edit.vue";
  //引入--查看--组件
  import show from "./ptMajorManagement_view.vue";
  //引入--添加--组件
  import add from "./ptMajorManagement_add.vue";
  //当前组件引入全局的util
  let Util=null;
  ...
  export default{
    data() {
      return {
        //查询表单
        deleteUrl: api.ptMajorRemove.path,
        formValidate: {
          "major":"",
          //"major_code":""
        },
