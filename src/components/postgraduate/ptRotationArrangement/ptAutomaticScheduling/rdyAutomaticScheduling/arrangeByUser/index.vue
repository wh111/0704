...
<template>
  <div>
    <el-steps style="margin: 0 auto; width: 98%;" :space="160" :active="active" finish-status="success">
      <el-step title="第一步：选择人员"></el-step>
      <el-step title="第二步：选择基地"></el-step>
    ...
    <div v-show="active==1" style="margin: 20px;">
      <second @setSecondVal="setSecondVal" :userType="userType"></second>
    </div>
    <!--- 第三步：选择培训标准 --->
    <div v-if="active==2" style="margin: 20px;">
      <third @setThirdVal="setThirdVal" :userType="userType" :initRtId="initRtId" :jdProclass="jdProclass" :schoolId="schoolId"></third>
    </div>
    <!--- 第四步：设置轮转时间 --->
