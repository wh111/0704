...
<template>
  <div id="content" ref="content" class="modal">
        ...
        <div class="add-remove">
          ...
          <span class="el-dropdown-link">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="列表"><Icon type="ios-paper-outline" size="18"></Icon> 列表</el-dropdown-item>
              <el-dropdown-item command="科室"><Icon type="ios-people" size="18"></Icon> 科室</el-dropdown-item>
              <el-dropdown-item command="人员"><Icon type="person" size="18"></Icon> 人员</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
      </div>
    ...
    <div v-if="isShowMoreSearch" >
      <el-form  :inline="true" label-width="74px">
        <el-row>
          ...
          <!--</el-select>-->
          <!--</el-form-item>-->
          <!--<el-form-item label="专业方向:" v-if="showView=='列表'">-->
          <!--<el-select filterable  v-model="formValidate.rtProclass" placeholder="请选择">-->
          <!--&lt;!&ndash;<select-option :type="'byNowUser'" ></select-option>&ndash;&gt;-->
          <!--<select-option type="byUserType"></select-option>-->
          <!--</el-select>-->
          <!--</el-form-item>-->
          <el-form-item label="培养方向:" v-if="showView=='列表'">
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <autoArrangeByDepList  v-if="showView=='科室'" :operailityData="formValidate" :userType="userType" :params="changeTabViewParams"></autoArrangeByDepList>
          <autoArrangeByUserList v-if="showView=='人员'" :operailityData="formValidate" :userType="userType" :params="changeTabViewParams"></autoArrangeByUserList>
      </div>
      <!--分页-->
    ...
    <Modal
      ...
      <add v-if="addModal" @cancel="cancel" @add="subCallback" :userType="userType" :operaility-data="operailityData"></add>
      <div slot="footer"></div>
    </Modal>
    <!--查看弹窗-->
    <Modal
      ...
      <show v-if="showModal" @cancel="cancel" :userType="userType" @show="subCallback" :operaility-data="operailityData"></show>
      <div slot="footer"></div>
    </Modal>
    <!--导出到excel弹窗-->
    <Modal
  ...
  export default{
    ...
    data() {
      return {
        ...
        exportDepUrl:api.userRotaryDepExportExcel.path+this.userType,
        exportUserUrl:api.userRotaryExportExcel.path+this.userType,
