<template>
  ...
  <div >
    ...
    <Modal
      ...
      <to-channel v-if="toChannelModal" @cancel="closeChannel" url="enroll/person/excelImport/add" @success="subHandelEvent" :data="convertedData" :format="format"></to-channel>
      <div slot="footer"></div>
    </Modal>
  </div>
</template>
