      ...
      <el-row >
        <el-col :span="18" :offset="2">
          <el-form-item label="排名:" prop="ranking" >
            <el-input v-model="formValidate.ranking"></el-input>
          </el-form-item>
        </el-col>
      </el-row >
  ...
  export default {
    ...
    data (){
      return{
        ...
        //form表单bind数据
        formValidate: {
          ranking:this.operailityData.ranking||"",  //成绩
        },
        userData:[],
        ...
        addMessTitle:{
          type:'ranking',
          successTitle:'设置综合排名成功!',
          errorTitle:'设置综合排名失败!',
          ajaxSuccess:'ajaxSuccess',
          ajaxError:'ajaxError',
          ajaxParams:{
            url:this.url.ranking.path+this.operailityData.id,
            method:this.url.ranking.method,
            data:{},
          }
        },
      }
