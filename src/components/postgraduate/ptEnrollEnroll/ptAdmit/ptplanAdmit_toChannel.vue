<template>
  ...
  <div>
    ...
    <Modal
      ...
      <to-channel v-if="toChannelModal" @cancel="closeChannel" url="/enroll/person/excelImport/enroll"
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.http = http + 'static/template/研究生录取人员表导入模板.xls';
      this.init();
    },
    methods: {
      /*
