...
<script>
  /*当前组件必要引入*/
  //引入--修改--组件
  import edit from "./yjsPersonnelManagement_edit";
  //引入--查看--组件
  import show from "./yjsPersonnelManagement_view.vue";
  //引入--添加--组件
  import add from "./yjsPersonnelManagement_add";
  //引入--导入--组件
  import toChannel from "./yjsPersonnelManagement_toChannel.vue";
  //引入--短信通知--组件
