...
<template>
  <layout-tree>
    ...
    <yjx-content slot="right" :deptId="deptId" :deptName="deptName" admin="true" :treeDefaults="treeDefaults"
                 :fromWhereTree="fromWhereTree" @refreshTree="refreshTree"></yjx-content>
  </layout-tree>
</template>
<script>
  /*当前组件必要引入*/
  ...
  // 住院医部门人员
  import yjxContent from "./yjsPersonnelManagement_content";
  export default {
    data() {
      return {
        //tree默认项设置
        treeDefaults: {
          getTreeUrl: "/dept/tree-by-YJS",
          getDataUrl: '',
          isShowMenus: true,
        },
        fromWhereTree: "user",
