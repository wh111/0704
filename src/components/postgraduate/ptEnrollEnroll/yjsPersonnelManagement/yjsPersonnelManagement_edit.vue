...
<template>
  <div>
    <yjx-basic-input :operailityData="formData" ref="yjxBasicInput"></yjx-basic-input>
    <br />
...
<script>
  import api from './api';
  // 研究生基本信息填写
  import  yjxBasicInput from '../../../common/archivesManagement/archivesManagement_basic/s_yjs/input.vue';
  export default {
    //props接收父组件传递过来的数据
    ...
    methods: {
      ...
      saveCurrData(isLoadingFun) {
        let data = this.$refs.yjxBasicInput.getInputData();
        if (data) {
