<template>
  ...
  <div>
      ...
      <el-row >
        <el-col :span="18" :offset="2">
          <el-form-item label="开题申请:"  >
            ...
            <!--<el-input v-model="formValidate.oldThesisTitle" readonly @focus="selectNoticeModal=true" placeholder="请输入"></el-input>-->
          </el-form-item>
        </el-col>
      </el-row >
    ...
    <Modal
      ...
      <select-notice v-if="oldId" @cancel="selectNoticeModal=false" @selectTemp="selectNotice" :url="url" :tempId="oldId" ></select-notice>
      <div slot="footer"></div>
    </Modal>
  </div>
</template>
    ...
    data (){
      return{
        ...
        editMessTitle:{
          ...
          ajaxError:'ajaxError',
          ajaxParams:{
            url:this.url.changeModify.path+this.operailityData.id,
            method:this.url.changeModify.method,
            data:{},
          }
        },
        oldId:'',
