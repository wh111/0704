...
<template>
  <div id="content" ref="content" class="modal">
    ...
    <Modal
      ...
      <add v-if="addModal" :again="again" @cancel="cancel" @add="subCallback" :operaility-data="operailityData" :url="url"></add>
      <div slot="footer"></div>
    </Modal>
    <!--修改-->
    <Modal
      ...
      <edit v-if="editModal" :again="again" @cancel="cancel" @edit="subCallback" :operaility-data="operailityData" :url="url"></edit>
      <div slot="footer"></div>
    </Modal>
    <!--删除弹窗-->
    <Modal
    ...
    <Modal
      ...
      <show v-if="showModal" :again="again" @cancel="cancel" @show="subCallback" :operaility-data="operailityData" :url="url"></show>
      <div slot="footer"></div>
    </Modal>
...
<script>
  ...
  import url from './api'
  //引入--新建--组件
  import add from "./changeProposalApplication_add.vue";
  //引入--修改--组件
  import edit from "./changeProposalApplication_edit.vue";
  //引入--查看--组件
  import show from "./changeProposalApplication_view.vue";
