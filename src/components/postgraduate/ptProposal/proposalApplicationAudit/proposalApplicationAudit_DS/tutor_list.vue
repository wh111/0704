    ...
    <el-form :model="formValidate" :rules="rules" ref="formValidate" inline>
      <el-row style="margin-bottom:0">
        ...
        <el-col :span="14" align="right">
          ...
          <el-form-item>
            <el-button v-if="!searchMore" type="info" @click="searchEvent">查询</el-button>
      ...
      <div v-show="searchMore" ref="searchMore" align="right">
        ...
        <el-form-item label="学位类型:">
          <el-select filterable v-model="formValidate.degree" clearable placeholder="请选择">
            <el-option label="全部" value=""></el-option>
        ...
        <el-form-item label="专业方向:">
          <el-select v-model="formValidate.specialtyName" clearable placeholder="请选择">
            <major value="major"></major>
          </el-select>
        </el-form-item>

        <el-form-item label="状态:" prop="status">
          <el-select filterable v-model="formValidate.status" clearable placeholder="请选择">
            <el-option label="全部" value=""></el-option>
