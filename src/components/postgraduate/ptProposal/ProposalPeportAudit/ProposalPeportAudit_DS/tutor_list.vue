      ...
      >
        <el-table
          ...
          <el-table-column
            ...
            width="80">
            <template scope="scope">
              <el-button size="small" :disabled="scope.row.status != 'DSDSH'" @click="audit(scope.row)">审核</el-button>
            </template>
          </el-table-column>
          <el-table-column
            show-overflow-tooltip
    ...
    data () {
      return {
        ...
        passData: {
          ...
          data: {status: 'JYSDSH', auditOpinion: '通过'}
        },
        rejectData: {
          url: this.url.tutorAudit.path,
          method: this.url.tutorAudit.method,
          data: {status: 'DSBH', auditOpinion: '驳回'}
        },
        style: {
          publish: false
        },
