...
<template>
  <div id="content" ref="content" class="modal" style="position: absolute;top: 10px;left: 10px;right:10px;bottom: 10px">
    ...
    <education :url="url" :peport="peport" v-else-if="typeView.includes('YJSGL') || typeView.includes('JYC')" :view="view" style="height: 100%"></education>
...
<script>
  ...
  import url       from './api';
  //导师审核
  import tutor     from './ProposalPeportAudit_DS/tutor_list.vue';
  //教研室审核
  import staffRoom from './ProposalPeportAudit_JYS/staffRoom_list.vue';
  //教育处审核
  import education from './ProposalPeportAudit_JYC/education_list.vue';
  //当前组件引入全局的util
  let Util = null;
  export default {
