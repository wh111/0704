<template>
  <div>
    <el-form :model="formValidate" :rules="rules" ref="formValidate" class="demo-form-inline" label-width="90px">
      ...
      <el-row>
        <el-col>
          <el-form-item label="审核意见:" prop="jysAuditOpinion">
            <el-input v-model="formValidate.jysAuditOpinion" type="textarea"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <br>
      ...
      <!--<el-row v-show="auditStep(getData.status)==2">-->
      <!--<el-col :span="20" :offset="2">-->
      <!--<el-form-item label="审核意见:" prop="jsyAuditOpinion">-->
      <!--<el-input v-model="formValidate.jysAuditOpinion" type="textarea"></el-input>-->
      <!--</el-form-item>-->
      <!--</el-col>-->
      <!--</el-row>-->
...
//          ids: this.operailityData.id,
        ...
        editMessTitle: {
          ...
          ajaxError: 'ajaxError',
          ajaxParams: {
            url: this.url.jysAudit.path + this.operailityData.id,
