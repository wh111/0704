      ...
      <el-row style="margin-bottom:0">
        ...
        <el-col align="right">
          <el-form-item prop="name" label="姓名">
            <el-input style="width:300px;" v-model="formValidate.applicantName" placeholder="输入姓名">
      ...
      >
        <el-table
          ...
          <el-table-column
            ...
            width="80">
            <template scope="scope">
              <el-button :disabled="scope.row.status != 'JYSDSH'" size="small" @click="audit(scope.row)">审核</el-button>
            </template>
          </el-table-column>
          <el-table-column
            show-overflow-tooltip
