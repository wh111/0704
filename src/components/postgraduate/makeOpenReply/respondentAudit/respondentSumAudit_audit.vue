      ...
      <el-row>
        <el-col :span="22" :offset="1">
          <el-form-item label="审批意见:" prop="auditOpinion">
            <el-input v-model="formValidate.auditOpinion" type="textarea" resize="none" :rows="8"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
    ...
    data() {
      return {
        ...
        auditMessTitle:{
          ...
          ajaxError:'ajaxError',
          ajaxParams:{
            url:api.defenseAppAudit.path+this.operailityData.id,
            method:api.defenseAppAudit.method,
          }
        },
      }
    },
