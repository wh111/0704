...
<template>
  <div id="content" ref="content" class="modal">
      ...
      <div v-show="searchMore" ref="searchMore" align="right">
        ...
        <el-form-item label="状态" prop="status">
          <el-select clearable v-model="formValidate.status" placeholder="请选择">
            ...
            <el-option label="教育处待审核" value="JYCDSH"></el-option>
            <el-option label="教育处不通过" value="JYCBH"></el-option>
            <el-option label="教育处通过" value="TG"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
      ...
      >
        <el-table
          ...
          <el-table-column
            ...
            width="80">
            <template scope="scope">
              <el-button :disabled="scope.row.status  != 'JYCDSH'" size="small" @click="audit(scope.row)">审核</el-button>
            </template>
          </el-table-column>
          <el-table-column
            show-overflow-tooltip
    ...
    <Modal
      ...
      <operate v-if="passModal" :type="'pass'" :methods="'post'" :operateData="passData" @cancel="cancel" @operate="subCallback"
    ...
    <Modal
      ...
      <operate v-if="rejectModal" :type="'reject'" :operateData="rejectData" :methods="'post'" @cancel="cancel" @operate="subCallback"
               :operaility-data="operailityData"></operate>
      <div slot="footer"></div>
    </Modal>
  </div>
    ...
    data () {
      return {
        ...
        listMessTitle: {
          ...
          ajaxParams: {
            url: this.url.jycAuditList.path,
            params: {}
          }
        },
        /*--按钮button--*/
