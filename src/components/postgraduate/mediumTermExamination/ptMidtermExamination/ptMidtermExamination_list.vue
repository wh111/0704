    ...
    <el-form :inline="true" :model="formInline" :rules="queryAssessment" class="demo-form-inline">
        ...
        <el-col :span="14" align="right">
          <el-form-item label="姓名" prop="name">
            <el-input v-model="formInline.name" placeholder="">
              <el-button @click="onSubmit" slot="append" icon="search"></el-button>
            </el-input>
          </el-form-item>
      ...
      <div v-if="searchMore" ref="searchMore" style="float: right">
        <el-form-item label="专业方向">
          <el-select v-model="formInline.specialtyName" placeholder="请选择">
      ...
      >
        <el-table
          ...
          <el-table-column
            ...
            width="160">
            <template scope="scope">
              <el-button v-if="scope.row.score == null " size="small" @click="Add(scope.row)">填写</el-button>
              <el-button v-else size="small" @click="Add(scope.row)" :disabled="true">填写</el-button>
            </template>
          </el-table-column>
          <el-table-column
            align="center"
...
<script>
  ...
  import api                 from '../api';
  //引入查看组件
  import show                from '../components/ptMidtermExamination_add.vue';
  //引入--修改--组件
