      ...
      <el-table align="center" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column label="操作" align="center" width="230">
          <template scope="scope">
            ...
            <!-- 上报才可审核 -->
            <el-button size="small" type="warning" @click="add(scope.row)" :disabled="!scope.row.hasSpReport">审核</el-button>
          </template>
        </el-table-column>
...
<script>
  ...
  import add from './outEducationReportAudit_add.vue';
