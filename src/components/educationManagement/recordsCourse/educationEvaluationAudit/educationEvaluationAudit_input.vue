  ...
  <div>
    ...
    <table class="el-table oeawInputTable">
      ...
      <tr>
        ...
        <td colspan="2">
          <div class="cell">
            ...
            <!--<el-date-picker v-model="formValidate.reviewTime" type="month" :editable="false" placeholder="请选择" @change="changeReviewTime"></el-date-picker>-->
      ...
      <tr>
        ...
        <td colspan="1">
          <div class="cell">
            <el-input v-model="formValidate.leaveEarlyTimes"></el-input>
          </div>
        </td>

        <td colspan="2">
          <div class="cell">
            <el-input v-model="formValidate.askLeaveDays"></el-input>
          </div>
        </td>
        <td colspan="2">
          <div class="cell">
      ...
      <tr>
        ...
        <td rowspan="3" colspan="7" >
          <div class="cell">
              <el-input v-model="formValidate.comments" type="textarea" :autosize="{ minRows: 2, maxRows: 4}"></el-input>
      ...
      <tr>
        <td >
          <div class="cell">
            <el-checkbox v-model="formValidate.inspectionLevel" true-label="OPTIMAL"></el-checkbox>
          </div>
        </td>
        <td >
          <div class="cell">
            <el-checkbox v-model="formValidate.inspectionLevel" true-label="GOOD"></el-checkbox>
          </div>
        </td>
        <td>
          <div class="cell">
            <el-checkbox v-model="formValidate.inspectionLevel" true-label="DIFF"></el-checkbox>
          </div>
        </td>
        <!--<td align="center" colspan="3">-->
          <!--<div class="cell">-->
    ...
    data() {
      return {
        ...
        formValidate: {
          ...
          comments: '', // 评语
          inspectionLevel: 'OPTIMAL', // 考核等级 OPTIMAL优|OOD良|DIFF差
          evaluationUserName:'',
          leaveEarlyTimes:'',
          askLeaveDays:'',
          jycMess:'',  //教育处意见
        ...
        messTitle: {
          ...
          ajaxError: 'ajaxError',
          ajaxParams: {
            url: api.review.path + this.operailityData.monthlyReviewId,
            method: api.review.method
          }
        },
      }
    },
...
//        };
      ...
      clearInputVal(ckeck,...keys){
        if(this.formValidate[ckeck] === 'Y'){
          keys.map(item=>this.formValidate[item]=0)
        }
      },
      // 设置选框的值
