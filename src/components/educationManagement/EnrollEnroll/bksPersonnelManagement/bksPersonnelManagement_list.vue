...
<template>
  <layout-tree>
    ...
    <zyy-content slot="right" :deptId="deptId" :fromWhereTree="fromWhereTree" @refreshTree="refreshTree"
                 :isClassNode="isClassNode" :deptName="deptName" :nodeNumber="nodeNumber" admin="true"
                 :treeDefaults="treeDefaults"></zyy-content>
  </layout-tree>
</template>
<script>
  /*当前组件必要引入*/
  ...
  // 住院医部门人员
  import zyyContent from "./bksPersonnelManagement_content";
