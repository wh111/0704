<template>
  ...
  <div>
    ...
    <el-row class="but-space">
      ...
      <el-col :span="16">
        <p>上传填好的部门人员信息表 ( 仅支持.xls/.xlsx格式)</p>
        </br>
    ...
    <!--导入-->
    <Modal :mask-closable="false" width="1100" v-model="toChannelModal" title="对话框标题"
           class-name="vertical-center-modal">
      <modal-header slot="header" :content="toChannelId"></modal-header>
      <to-channel v-if="toChannelModal" :handsontableOptions="handsontableOptions" @cancel="closeChannel"
                  :url="importUrl" @success="subHandelEvent"
                  :ch2en="ch2en" :data="convertedData"
  ...
  export default {
    ...
    data() {
      return {
        ...
        importUrl: api.import.path + this.deptId,
        //导入条件
        loadBtn: {
          title: '提交',
    ...
    mounted() {
      ...
      this.http = http + 'static/template/部门人员信息模板-本科生.xls';
      this.init();
    },
    methods: {
      /*
