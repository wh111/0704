      ...
      <div class="itemLayout">
        <fieldset>
          ...
          <el-row style="text-align: center;margin-bottom: 5px;font-size: 16px;">
            ...
            <el-col :span="3">
              <span style="color:#ff4949;;">*</span>最优
            </el-col >
    ...
    data (){
      return{
        ...
        addMessTitle:{
          ...
          ajaxSuccess(){
            this.$emit('getHeight',this.operailityData);
