  ...
  <div id="content" ref="content" class="modal">
    ...
    >
        ...
        <el-row >
          <el-col :span="6">
            <el-form-item label="姓名" prop="name">
              <el-input v-model="formValidate.pickerOptions" placeholder="请输入" ></el-input>
            </el-form-item>
      ...
      <div class="add-remove">
        ...
        <el-button class="but-col" @click="forbidden" type="danger">禁用</el-button>
      ...
      <div style="margin: 10px;">
        ...
        <Modal
          ...
          <toChannel v-if="toChannelModal"  @remove="subCallback" @cancel="cancel" :operaility-data="operailityData"></toChannel>
          <div slot="footer"></div>
        </Modal>
        <!---->
        <!--短信通知弹窗-->
...
//      短信通知
    ...
    components:{
      //当前组件引入的子组件
      edit,add,show,toChannel,shortNote
    }
