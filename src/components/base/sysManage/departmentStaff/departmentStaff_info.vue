...
<script>
  /*引入查看的子组件*/
  //  引入--基本情况--组件
  import basic from '../../../common/archivesManagement/archivesManagement_basic/other/input.vue';
  //  引入--学历信息--组件
...
//  import train from '../../../common/archivesManagement/archivesManagement_edit/archivesManagement_edit_train.vue';
  ...
  import {basicAddRules} from '../rules';
...
//        allTab:['basic','education','workExperience','professionalSkill','credentials','teachingExperience',/*'study','train',*/'awards','scientific','papers'],
        allTab:['basic','education','workExperience','professionalSkill','credentials','teachingExperience','awards','scientific','papers'],
        saveTab:[],
      };
    },
    methods: {
