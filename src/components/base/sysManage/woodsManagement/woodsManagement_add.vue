    ...
    <el-form :model="formValidate" ref="formValidate" :rules="rules" class="demo-form-inline" label-width="80px" >
      ...
      <el-row >
        <el-col :span="9" :offset="2">
            ...
            <dictionary-select style="width: 90%" @setSltOptionValue="setSpecialtyOptionValue" :selectOptions="specialtyOptions"></dictionary-select>
          </el-form-item>
        </el-col>
...
<script>
  ...
  export default {
    data (){
      return{
        ...
        addMessTitle:{
          ...
          ajaxError:'ajaxError',
          ajaxParams:{
            url:'/rotaryBasis/BaseManage/add',
            method:'post',
            jsonString:true
          }
        },
    ...
    methods:{
      ...
      //添加科室
      addDep(){
        this.operailityData = this.formValidate.jdDep;
