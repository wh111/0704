...
<template>
  <div>
    ...
    <el-tabs v-show="showTab" v-model="activeName">
      ...
      <!--&lt;!&ndash;   工作经历&ndash;&gt;-->
      <!--<keep-alive>-->
      <!--<work-experience :data-id="operailityData.id" v-if="activeName==='work-experience'" :byFilter=byFilter></work-experience>-->
      <!--</keep-alive>-->
      <!--</el-tab-pane>-->
      <!--<el-tab-pane label="专业技术职称晋升情况" name="professional-skill">-->
      <!--&lt;!&ndash; 专业技术职称晋升情况&ndash;&gt;-->
      <!--<keep-alive>-->
      <!--<professional-skill :data-id="operailityData.id" v-if="activeName==='professional-skill'" :byFilter=byFilter></professional-skill>-->
      <!--</keep-alive>-->
      <!--</el-tab-pane>-->
      ...
      <!--&lt;!&ndash;教学经历&ndash;&gt;-->
      <!--<keep-alive>-->
      <!--<teaching-experience :data-id="operailityData.id" v-if="activeName==='teaching-experience'" :byFilter=byFilter></teaching-experience>-->
      <!--</keep-alive>-->
      <!--</el-tab-pane>-->
    ...
    <div v-show="!showTab">
      <template v-if="initShowData">
        ...
        <!--<professional-skill :data-id="operailityData.id" class="archivesItems" :byFilter=byFilter></professional-skill>-->
        <credentials :data-id="operailityData.id" class="archivesItems" :byFilter="byFilter"></credentials>
        <!--<teaching-experience :data-id="operailityData.id" class="archivesItems" :byFilter=byFilter></teaching-experience>-->
