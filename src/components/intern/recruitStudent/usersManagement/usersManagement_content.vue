...
<template>
  <div id="content" ref="content" class="modal">
    ...
    <div id="myTable" ref="myTable">
      <el-table ref="multipleTable" align="center" :height="tabHeight" :context="self" :data="tableData1"
    ...
    <div>
      ...
      <Modal :mask-closable="false" v-model="showModal" height="200" class-name="vertical-center-modal" :width="1100">
        ...
        <show v-if="showModal" @cancel="cancel" :operaility-data="operailityData" :byFilter="true"></show>
        <div slot="footer"></div>
      </Modal>
      <!--删除弹窗-->
      ...
      <!--部门调动-->
      <Modal :mask-closable="false" v-model="depMoveModal" height="200" class-name="vertical-center-modal"
             :width="960">
...
<script>
  ...
  //引入--查看--组件
  import show from "./usersManagement_view.vue";
  //引入--添加--组件
  ...
  let Util = null;
  export default {
    props: ['deptId', 'deptName', 'admin', 'treeDefaults'],
    data() {
      return {
        sexOption,
        auditStatusOption,
    ...
    watch: {
      deptId(val) {
        if (val ) {
          ...
          this.tableData = [];
          this.downUserPortraitUrl = "javascript:;";
        }
      }
    }
  }
