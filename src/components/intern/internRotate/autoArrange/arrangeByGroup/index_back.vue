...
<template>
  <div>
    <el-steps style="margin: 0 auto; width: 98%;" :space="200" :active="active" finish-status="success">
      <el-step title="第一步：选择学校"></el-step>
      <el-step title="第二步：设置轮转开始时间"></el-step>
    ...
    <div v-show="active==0" style="margin: 20px;">
                ...
                <el-col :span="20">
                  <el-tooltip v-if="item.name&&item.name.length>10" :content="item.name" effect="light" placement="top">
                    <el-button class="overflow-txt" :type="item.checked?'success':''"
                               @click="handleCheckSchool(index,item)" style="width: 100%"
                               v-text="item.name"></el-button>
                  </el-tooltip>
                  <el-button v-else class="overflow-txt" :type="item.checked?'success':''"
      ...
      <el-row style="margin-top: 10px;">
        <el-col :span="8">
          <div class="cal-schoolTit" style="text-align: right;">大纲：</div>
        </el-col>
        <el-col :span="14">
          <el-select
            v-model="sltedDg"
          ...
          <span v-if="getDgBySpecialty.length==0"
                style="color: #FF0000">&nbsp;&nbsp;&nbsp;&nbsp;您还没有选择学校或者该学校下没有对应的大纲!</span>
          <span v-if="getDgBySpecialty.length>0&&sltedDg==''"
                style="color: #FF0000">&nbsp;&nbsp;&nbsp;&nbsp;请选择对应的大纲!</span>
        </el-col>
      </el-row>
      <el-row style="margin-top: 10px;">
        <el-col :span="8">
