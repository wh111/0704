...
<template>
  <div id="content" ref="content" class="modal">
      ...
      <el-row style="margin-bottom:0">
        ...
        <el-col :span="24" align="right">
          <el-form-item label="学校：">
            <el-select v-model="formValidate.schoolId" style="width:300px;" clearable filterable
                       placeholder="请选择">
              <select-option :url="api.schools.path"></select-option>
            </el-select>
          </el-form-item>
          ...
          <el-table-column label="操作" width="80" align="center">
            <template scope="scope">
              <el-button
                ...
                size="small"
                :disabled="canTrimming(scope.row)"
                type="primary"
    ...
    <Modal
      ...
      <trimming v-if="editModal" :url="api" type="group" :api="api" @cancel="cancel" @edit="subCallback"
                :operaility-data="operailityData"></trimming>
      <div slot="footer"></div>
    </Modal>
    <!---->
    <!--删除弹窗-->
  ...
  export default {
    data () {
      return {
        ...
        severStampTime: this.$store.getters.getEnvPath.nowTime,
    ...
    methods: {
      ...
      //是否能够进行微调 是 返回false
      canTrimming (rowData) {
        return this.severStampTime > this.parseTimestamp(rowData.beginTime) + 14 * 86400000;
      },
