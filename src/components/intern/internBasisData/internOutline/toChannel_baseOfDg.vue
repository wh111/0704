      ...
      conductQueryData(data){
       ...
       let index = -1;
        ...
        for(let i=0;i<queryData.length;i++){
              if(queryData[i].schoolName!=""){
                index++;
                tempArr.push({
                  schoolName:queryData[i].schoolName,
                  specialty:queryData[i].specialty,
                  gradeNum:queryData[i].gradeNum,
                  outlines:[],
                });
              }else{
                tempArr[index].outlines.push(queryData[i]);
              }
          }
        return tempArr
      },
