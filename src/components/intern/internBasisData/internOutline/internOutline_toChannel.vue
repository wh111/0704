...
<template>
  ...
  <div >
    ...
    <Modal
      ...
      <to-channel v-if="toChannelModal" @cancel="closeChannel" :url="api.dgToChannel.path" @success="subHandelEvent" :data="convertedData" :format="format"></to-channel>
      <div slot="footer"></div>
    </Modal>
  </div>
</template>
<script>
  import toChannel from './toChannel_baseOfDg.vue'
  ...
  export default {
    ...
    data (){
      return{
        ...
        toChannelId:{id:'toChannelId',title:'实习大纲表'},
        convertedData:{},
        format :{
          '学校名称':'schoolName',
          "年级":"gradeNum",
