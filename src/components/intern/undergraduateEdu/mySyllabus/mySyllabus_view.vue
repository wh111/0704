  ...
  <div class="showWrapper">
    <el-form class="demo-form-inline" label-width="100px">
      ...
      <div v-for="(item,index) in data">
        ...
        <el-row :gutter="20" class="row-bg">
          <el-col :span="9" :offset="2"><p><strong>教学方法:</strong> {{item.courseMethod}} </p></el-col>
        </el-row>
        <el-row :gutter="20" class="row-bg">
          <el-col :span="18" :offset="2"><p><strong>授课内容:</strong>{{item.courseContent}}  </p></el-col>
        </el-row>
        <br>
        <el-row class="row-bg">
