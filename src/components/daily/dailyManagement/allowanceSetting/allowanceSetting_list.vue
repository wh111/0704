        ...
        <el-col :span="22" :offset="1">
          <fieldset class="lose-margin2" style="margin-bottom: 30px">
            ...
            <el-row v-for="(item,index) in YJS" :key="index">
              <el-col :span="3">
                <el-form ref="formValidate" :rules="rules" :model="item.calculationMethod"  >
                  <el-form-item prop="minScore" label-width="0">
                    <el-input  v-model="item.calculationMethod.minScore" placeholder="请输入"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
              <el-col :span="7">
                <el-form ref="formValidate" :rules="rules" :model="item.calculationMethod" >
                  <el-form-item prop="maxScore" label="≤ 综合评分 ≤" label-width="120px">
                    <el-input   v-model="item.calculationMethod.maxScore" placeholder="请输入"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
              <el-col :span="4">
                <el-form ref="formValidate" :rules="rules" :model="item.calculationMethod"  >
                  <el-form-item prop="master" label="硕士:" label-width="60px">
                    <el-input  v-model="item.calculationMethod.master" placeholder="请输入"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
              <el-col :span="2">
              ...
              <el-col :span="4">
                <el-form ref="formValidate" :rules="rules" :model="item.calculationMethod"  >
                  <el-form-item prop="doctor" label="博士:" label-width="60px">
                    <el-input   v-model="item.calculationMethod.doctor"
          ...
          <fieldset class="lose-margin2" style="margin-bottom: 30px">
            ...
            <el-row>
              <el-col :span="5">
                <el-form ref="formValidate" :rules="rules" :model="ZYY.calculationMethod"  >
                  <el-form-item prop="amount" label="全额发放:" label-width="85px">
                    <el-input  v-model="ZYY.calculationMethod.amount"
                              placeholder="请输入"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
              ...
              <el-col :span="5">
                <el-form ref="formValidate" :rules="rules" :model="ZYY.calculationMethod"  >
                  <el-form-item prop="absence" label="旷工扣发:" label-width="85px">
                    <el-input v-model="ZYY.calculationMethod.absence" placeholder="请输入"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
              <el-col :span="2">
              ...
              <el-col :span="5">
                <el-form ref="formValidate" :rules="rules" :model="ZYY.calculationMethod"  >
                  <el-form-item prop="leave" label="请假扣发:" label-width="85px">
                    <el-input  v-model="ZYY.calculationMethod.leave"
                              placeholder="请输入"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
          ...
          <fieldset class="lose-margin2" style="margin-bottom: 30px">
            ...
            <el-row>
              <el-col :span="6">
                <el-form ref="formValidate" :rules="rules" :model="JXS.calculationMethod"  >
                  <el-form-item prop="good" label="考核等级优:" label-width="100px">
                    <el-input   v-model="JXS.calculationMethod.good"
                              placeholder="请输入"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
              ...
              <el-col :span="5">
                <el-form ref="formValidate" :rules="rules" :model="JXS.calculationMethod"  >
                  <el-form-item prop="well" label="良:" label-width="45px">
                    <el-input   v-model="JXS.calculationMethod.well"
                              placeholder="请输入"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
              ...
              <el-col :span="5">
                <el-form ref="formValidate" :rules="rules" :model="JXS.calculationMethod"  >
                  <el-form-item prop="bad" label="差:" label-width="45px">
                    <el-input   v-model="JXS.calculationMethod.bad"
                              placeholder="请输入"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
...
<script>
  //当前组件引入全局的util
  import {allowanceSetting as rules} from '../rules'
  let Util = null;
  export default {
    //props接收父组件传递过来的数据
      ...
      * */
      ...
      listenSubEvent(isLoadingFun) {
        ...
        if (isSubmit) {
          ...
          this.YJS.map((item,index)=>{
            if(item.calculationMethod.minScore>item.calculationMethod.maxScore){
              this.errorMess(`第${index}行最小综合评分不能大于最大综合评分`);
              return;
            }
          })
