  ...
  <div ref="content">
    ...
    <div ref="table">
      <el-table align="center" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column label="监考任务" prop="name" align="center"></el-table-column>
        <el-table-column label="监考人" prop="userList" show-overflow-tooltip></el-table-column>
        <el-table-column label="监考要求" prop="invigilateRequirement" show-overflow-tooltip></el-table-column>
...
<script>
  /*当前组件必要引入*/
  import api from '../api';
  import add from './llksjk_add.vue';
  //当前组件引入全局的util
  let Util = null;
  export default {
    name: 'llksjk_list',
    ...
    methods: {
      ...
      init: function () {
        ...
        this.queryQptions = {
          url: api.listllKsjk.path,
          method: api.listllKsjk.method,
          params: {
            curPage: 1,
      ...
      /*--点击--删除--按钮--*/
      remove () {
        this.deleteUrl = api.llKsjkdelete;
        this.operailityData = this.multipleSelection;
