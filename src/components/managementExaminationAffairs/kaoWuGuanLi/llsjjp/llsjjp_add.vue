...
<script>
  /*当前组件必要引入*/
  import { llKsjpamination as rules } from '../rules';
  import api from '../api';
  //当前组件引入全局的util
  let Util = null;
  export default {
    ...
    data () {
      return {
        ...
        llKssjfxAddTitle: {
          ...
          ajaxParams: {
            jsonString: true,
            url: api.llKsjpAdd.path,
            method: api.llKsjpAdd.method,
            data: {}
          }
        },
        classnameTitle: {
      ...
      init () {
        ...
        if (this.type == 'edit') {
          ...
          this.editsaveTitle = {
            ...
            ajaxParams: {
              jsonString: true,
              url: api.editllKsjp.path + this.operailityData[0].id,
              method: api.editllKsjp.method,
              data: {}
            }
          },
            this.listMessTitle = {
              ...
              ajaxParams: {
                url: api.llKsjpedit.path + this.operailityData[0].id
              }
            };
