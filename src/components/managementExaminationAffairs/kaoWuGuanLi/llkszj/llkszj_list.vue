  ...
  <div ref="content">
      ...
      <el-form :inline="true">
        ...
        <el-col :span="20" align="right">
          ...
          <el-form-item label="试卷名称：">
            <el-input v-model="searchObj.className"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <div ref="table">
      <el-table align="center" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column label="组卷描述" prop="describes" show-overflow-tooltip></el-table-column>
        <el-table-column label="组卷人" prop="userList" show-overflow-tooltip></el-table-column>
...
<script>
  /*当前组件必要引入*/
  import api from '../api';
  import edit from './llkszj_edit.vue';
  //当前组件引入全局的util
  let Util = null;
  export default {
    name: 'llkszj_list',
    ...
    methods: {
      ...
      init: function () {
        ...
        this.queryQptions = {
          url: api.listllkszj.path,
          method: api.listllkszj.method,
          params: {
            curPage: 1,
      ...
      /*--点击--删除--按钮--*/
      remove () {
        this.deleteUrl = api.llkszjdelete;
        this.operailityData = this.multipleSelection;
