  ...
  <div>
    <el-form :model="formValidate" ref="formValidate" :rules="rules" class="demo-form-inline" label-width="130px">
      <el-row>
        ...
        <el-col :span="9">
          <el-form-item label="试卷分析人：" prop="userList">
      ...
      <el-row>
        <el-col :span="18" :offset="2">
          <el-form-item label="分析要求:" prop="anRequirement">
            <el-input type="textarea" resize="none" :rows="8" v-model="formValidate.anRequirement"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
<script>
  /*当前组件必要引入*/
  import { llsjfxamination as rules } from '../rules';
  import api from '../api';
  //当前组件引入全局的util
  let Util = null;
  export default {
    ...
    data () {
      return {
        ...
        llKssjfxAddTitle: {
          ...
          ajaxParams: {
            jsonString: true,
            url: api.llKssjfxAdd.path,
            method: api.llKssjfxAdd.method,
            data: {}
          }
        },
        classnameTitle: {
    ...
    methods: {
      ...
      init () {
        ...
        if (this.type == 'edit') {
          ...
          this.editsaveTitle = {
            ...
            ajaxParams: {
              jsonString: true,
              url: api.editllKssjfx.path + this.operailityData[0].id,
              method: api.editllKssjfx.method,
              data: {}
            }
          },
            this.listMessTitle = {
              ...
              ajaxParams: {
                url: api.llKssjfxedit.path + this.operailityData[0].id
              }
            };
      ...
      listenSubEvent (isLoadingFun) {
        ...
        if (isSubmit) {
          ...
          if (this.type == 'add') {
            saveTitle = this.llKssjfxAddTitle;
          } else {
