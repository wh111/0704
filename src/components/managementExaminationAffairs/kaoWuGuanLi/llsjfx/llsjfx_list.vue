  ...
  <div ref="content">
    <el-row>
      <el-form :inline="true">
        ...
        <el-col :span="20" align="right">
          ...
          <el-form-item label="试卷分析任务：" prop="name">
    ...
    <div ref="table">
      <el-table align="center" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column label="试卷分析任务" prop="name" align="center"></el-table-column>
        <el-table-column label="试卷分析人" prop="userList" show-overflow-tooltip></el-table-column>
        <el-table-column label="分析要求" prop="anRequirement" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="试卷名称" prop="examName" show-overflow-tooltip></el-table-column>
    ...
    <Modal :mask-closable="false" v-model="addModal" height="200" class-name="vertical-center-modal" :width="940">
      ...
      <add v-if="addModal" @cancel="cancel" @add="subCallback" :operaility-data="operailityData" :type="type"></add>
      <div slot="footer"></div>
    </Modal>
    <!--模态框 编辑（edit） -->
    <Modal :mask-closable="false" v-model="editModal" height="200" class-name="vertical-center-modal" :width="940">
      ...
      <add v-if="editModal" @cancel="cancel" @edit="subCallback" :operaility-data="operailityData" :type="type"></add>
      <div slot="footer"></div>
    </Modal>
    <!-- 模态框 删除（del） -->
...
<script>
  /*当前组件必要引入*/
  import api from '../api';
  import add from './llsjfx_add.vue';
  //当前组件引入全局的util
  let Util = null;
  export default {
    name: 'llsjfx_list',
    ...
    methods: {
      ...
      init: function () {
        ...
        this.queryQptions = {
          url: api.listllKssjfx.path,
          method: api.listllKssjfx.method,
          params: {
            curPage: 1,
      ...
      /*--点击--删除--按钮--*/
      remove () {
        this.deleteUrl = api.llKssjfxdelete;
        this.operailityData = this.multipleSelection;
