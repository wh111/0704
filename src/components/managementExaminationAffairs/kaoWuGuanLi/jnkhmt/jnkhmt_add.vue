...
<template>
  <div>
    <el-form :model="formValidate" ref="formValidate" :rules="rules" class="demo-form-inline" label-width="130px">
      ...
      <el-row>
        <el-col :span="18" :offset="2">
          <el-form-item label="命题要求:" prop="proRequirement">
            <el-input type="textarea" resize="none" :rows="8" v-model="formValidate.proRequirement"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
<script>
  /*当前组件必要引入*/
  import { jnKhmtamination as rules } from '../rules';
  import api from '../api';
  //当前组件引入全局的util
  let Util = null;
  export default {
    ...
    data () {
      return {
        ...
        jnKhmtAddTitle: {
          ...
          ajaxParams: {
            jsonString: true,
            url: api.jnKhmtAdd.path,
            method: api.jnKhmtAdd.method,
            data: {}
          }
        },
        pickerOptions0: {
      ...
      init () {
        ...
        if (this.type == 'edit') {
          this.editsaveTitle = {
            ...
            ajaxParams: {
              jsonString: true,
              url: api.editjnKhmt.path + this.operailityData[0].id,
              method: api.editjnKhmt.method,
              data: {}
            }
          },
            this.listMessTitle = {
              ...
              ajaxParams: {
                url: api.jnKhmtedit.path + this.operailityData[0].id
              }
            };
