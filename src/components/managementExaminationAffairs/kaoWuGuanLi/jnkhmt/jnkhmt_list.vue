  ...
  <div ref="content">
    ...
    <div ref="table">
      <el-table align="center" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column label="命题要求" prop="proRequirement" show-overflow-tooltip></el-table-column>
...
<script>
  /*当前组件必要引入*/
  import api from '../api';
  import add from './jnkhmt_add.vue';
  //当前组件引入全局的util
  let Util = null;
  export default {
    name: 'jnkhmt_list',
    ...
    methods: {
      ...
      init: function () {
        ...
        this.queryQptions = {
          url: api.listjnKhmt.path,
          method: api.listjnKhmt.method,
          params: {
            curPage: 1,
      ...
      /*--点击--删除--按钮--*/
      remove () {
        this.deleteUrl = api.jnKhmtdelete;
        this.operailityData = this.multipleSelection;
