  ...
  <div ref="content">
    ...
    <div ref="table">
      <el-table align="center" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column label="判卷任务" prop="name" align="center"></el-table-column>
        <el-table-column label="判卷人" prop="userList" show-overflow-tooltip></el-table-column>
        <el-table-column label="判卷要求" prop="requirement" show-overflow-tooltip></el-table-column>
...
<script>
  /*当前组件必要引入*/
  import api from '../api';
  import add from './llkspj_add.vue';
  //当前组件引入全局的util
  let Util = null;
  export default {
    name: 'llkspj_list',
    ...
    methods: {
      ...
      init: function () {
        ...
        this.queryQptions = {
          url: api.listllkspj.path,
          method: api.listllkspj.method,
          params: {
            curPage: 1,
      ...
      /*--点击--删除--按钮--*/
      remove () {
        this.deleteUrl = api.llKspjdelete;
        this.operailityData = this.multipleSelection;
