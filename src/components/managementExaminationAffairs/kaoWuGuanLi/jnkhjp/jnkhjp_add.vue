    ...
    <el-form :model="formValidate" ref="formValidate" :rules="rules" class="demo-form-inline" label-width="130px">
      <el-row>
        <el-col :span="9" :offset="2">
          <el-form-item label="讲评任务：" prop="name">
            <el-input v-model="formValidate.name"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9">
          <el-form-item label="讲评人：" prop="userList">
      ...
      <el-row>
        <el-col :span="18" :offset="2">
          <el-form-item label="讲评要求:" prop="commentRequirement">
            <el-input type="textarea" resize="none" :rows="8" v-model="formValidate.commentRequirement"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <!--<el-select v-model="formValidate.examName" placeholder="请选择">-->
      <!--<el-option-->
...
<script>
  /*当前组件必要引入*/
  import { jnKhjptamination as rules } from '../rules';
  import api from '../api';
  //当前组件引入全局的util
  let Util = null;
  export default {
    ...
    data () {
      return {
        ...
        jnKhjpAddTitle: {
          ...
          ajaxParams: {
            jsonString: true,
            url: api.jnKhjpAdd.path,
            method: api.jnKhjpAdd.method,
            data: {}
          }
        },
        classnameTitle: {
    ...
    methods: {
      ...
      init () {
        ...
        if (this.type == 'edit') {
          this.editsaveTitle = {
            ...
            ajaxParams: {
              jsonString: true,
              url: api.editjnKhjp.path + this.operailityData[0].id,
              method: api.editjnKhjp.method,
              data: {}
            }
          },
            this.listMessTitle = {
              ...
              ajaxParams: {
                url: api.jnKhjpedit.path + this.operailityData[0].id
              }
            };
      ...
      classNameificationchange (value) {
        if (value) {
          ...
          let opt = {
            ajaxSuccess: (res) => {
              this.ExameInfoList = res.data.exameNameList;

              // this.setTableData();//再获取数据
            },
            ajaxParams: {
