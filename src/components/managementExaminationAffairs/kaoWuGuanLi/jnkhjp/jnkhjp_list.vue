  ...
  <div ref="content">
    <el-row>
      <el-form :inline="true">
        ...
        <el-col :span="20" align="right">
          ...
          <el-form-item label="考试讲评任务：" prop="name">
    ...
    <div ref="table">
      <el-table align="center" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column label="考试讲评任务" prop="name" align="center"></el-table-column>
        <el-table-column label="讲评人" prop="userList" show-overflow-tooltip></el-table-column>
        <el-table-column label="讲评要求" prop="commentRequirement" show-overflow-tooltip></el-table-column>
...
<script>
  /*当前组件必要引入*/
  import api from '../api';
  import add from './jnkhjp_add.vue';
  //当前组件引入全局的util
  let Util = null;
  export default {
    name: 'jnkhjp_list',
    ...
    methods: {
      ...
      init: function () {
        ...
        this.queryQptions = {
          url: api.listjnKhjp.path,
          method: api.listjnKhjp.method,
          params: {
            curPage: 1,
      ...
      /*--点击--删除--按钮--*/
      remove () {
        this.deleteUrl = api.jnKhjpdelete;
        this.operailityData = this.multipleSelection;
