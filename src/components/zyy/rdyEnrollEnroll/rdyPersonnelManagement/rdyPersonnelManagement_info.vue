...
<template>
  <div :class="{'userInfoAllShow': !showTab }">
    ...
    <basic class="userInfoItem" :dataId="operailityData.id" v-show="!showTab || activeName==='basic'" ref="basic" @save="saveCall" :addRules="addRules" :mustUploadHP="mustUploadHP"></basic>
...
<script>
  /*引入查看的子组件*/
  //  引入--基本情况--组件
  import basic from '../../../common/archivesManagement/archivesManagement_basic/s_zyy/input.vue';
  //  引入--学历信息--组件
  ...
  export default {
    ...
    methods: {
       ...
       * */
      init(){
        this.addRules = this.$util._.defaultsDeep({},basicAddRules,zyyUserInfo);
      },
