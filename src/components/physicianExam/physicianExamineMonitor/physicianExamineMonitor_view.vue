...
<template>
  <el-row class="physicianExamBox">
    <template v-if="formValidate instanceof Object">
      <el-row class="physicianExamMainBox">
        ...
        <el-col>
          <div class="fiveFloor">
            ...
            <br>
            <el-row>
              <el-col :span="3" v-for="(item,index) in formValidate.one" :key="index" align="center">
                <el-form>
                  <el-form-item>
        ...
        <el-col>
          <div class="fiveFloor">
            ...
            <br>
            <el-row>
              <el-col :span="3" v-for="(item,index) in formValidate.two" :key="index" align="center">
                <el-form>
                  <el-form-item>
      ...
      <el-col class="physicianExamBtns">
        <el-col :span="12">
          <b>考室状态：</b>
          <el-button type="success" size="mini">无人</el-button>
          <el-button type="info" size="mini">已安排</el-button>
          <el-button type="danger" size="mini">考试中</el-button>
        </el-col>
        <el-col :span="12" align="right">
          广播服务状态：<span>{{ getJobStatusText(jobStatus) }}</span>
        </el-col>
      </el-col>
    </template>
  ...
  export default {
    ...
    methods: {
      ...
      loadInfo () {
        ...
        this.jobStatus = this.showData instanceof Object ? this.showData.jobStatus : '';
