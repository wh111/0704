<template>
  <div>
    ...
    <el-table align="center" :context="self" :data="tableData" tooltip-effect="dark"
      ...
      <template v-else>
        <el-table-column label="考核内1容名称" width="180" prop="contentName" show-overflow-tooltip>
          <template scope="scope">
            <el-input v-model="scope.row.contentName" :maxlength="20"></el-input>
          </template>
        </el-table-column>
    ...
    <!-- 模态框 选择评分表（select） -->
    <Modal :mask-closable="false" v-model="scoreSelectModal" height="200" class-name="vertical-center-modal"
           :width="840">
    ...
    <!-- 模态框 选择SP评分表（select） -->
    <Modal :mask-closable="false" v-model="spScoreSelectModal" height="200" class-name="vertical-center-modal"
           :width="840">
    ...
    <!-- 模态框 选择病例表（select） -->
    <Modal :mask-closable="false" v-model="caseSelectModal" height="200" class-name="vertical-center-modal"
           :width="840">
    ...
    <!-- 模态框 选择剧本（select） -->
    <Modal :mask-closable="false" v-model="scriptSelectModal" height="200" class-name="vertical-center-modal"
           :width="840">
    ...
    <!-- 模态框 理论考试试题编辑 -->
    <Modal :mask-closable="false" v-model="editPaperContentModal" height="200" class-name="vertical-center-modal"
           :width="1000">
    ...
    <!-- 模态框 理论考试试题预览 -->
    <Modal :mask-closable="false" v-model="viewPaperContentModal" height="200" class-name="vertical-center-modal"
           :width="1000">
      <modal-header slot="header" :content="headerContent.viewPaperContentId"></modal-header>
      <view-paper-content v-if="viewPaperContentModal" :showData="tableData[row].paperContentList"
                          @cancel="cancel"></view-paper-content>
      <div slot="footer"></div>
    </Modal>
  </div>
</template>
