    ...
    <layout-tree style="height: 550px">
      ...
      <div slot="right" id="content" ref="content" class="modal">
        ...
        <div style="margin: 0 auto;width: 630px;">
          <Transfer :data="leftListData" :target-keys="rightTargetKeys" :list-style="listStyle" :operations="['向左移动','向右移动']" not-found-text="无信息,请选择左侧菜单!"
  ...
  export default {
    ...
    methods: {
      ...
      treeClick (obj, node, self, isLeaf) {
        this.clickId = obj.id;
        this.formateTreeData(obj, isLeaf);
      },
      /*
       * 设置右侧框中选择的数据
       * @param obj {}  右侧框中的数据
