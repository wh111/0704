...
<template>
  <div >
      ...
      <el-row class="but-space">
        ...
        <el-col :span="16" >
        <p>上传填好的剧本信息表 ( 仅支持.xls/.xlsx格式)</p></br>
  ...
  export default {
    ...
    data (){
      return{
        ...
        toChannelId:{id:'toChannelId',title:'剧本信息表'},
        convertedData:{},
        format :{
          "病例名称":"caseName",
          "剧本名称":"scriptName",
...
//        },
    ...
    methods:{
      ...
      init(){
        ...
        this.http = http+ 'static/template/剧本导入模板.xls';
      },
      /*
       * 点击提交按钮 监听是否提交数据
       ...
       * */
      success(){
        this.$emit('scripts','scripts',`导入${this.totalNumber}条数据`);
      },

      cancel(){
        this.$emit('cancel','scripts');
      },
      /*
       * 获取表单数据
