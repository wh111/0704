    ...
    methods: {
      ...
      listenSubEvent (isLoadingFun) {
        ...
        if (isSubmit) {
          ...
          let data = this.copyMessTitle.ajaxParams.data;
      ...
      getDataForServer () {
        this.ajax({
          ajaxSuccess: res => {
            ...
            this.formValidate.scriptList = []; // 剧本
            this.formValidate.scriptIds = '';
            this.formValidate.caseName = '';
          },
          ajaxParams: {
