<template>
  <div class="editForm">
      ...
      <el-row>
        ...
        <el-col :span="20" :offset="2">
          <el-form-item label="评分表：">
            <div class="scriptListItemText" v-if="formValidate.scoreTableId">
    ...
    <!-- 模态框 增加剧本（add） -->
    <Modal :mask-closable="false" v-model="scriptsAddModal" height="200" class-name="vertical-center-modal" :width="840">
    ...
    <!-- 模态框 编辑剧本（edit） -->
    <Modal :mask-closable="false" v-model="scriptsEditModal" height="200" class-name="vertical-center-modal" :width="840">
    ...
    <!-- 模态框 查看剧本（show） -->
    <Modal :mask-closable="false" v-model="scriptsShowModal" height="200" class-name="vertical-center-modal" :width="840">
    ...
    <!-- 模态框 查看评分表（show） -->
    <Modal :mask-closable="false" v-model="scoreShowModal" height="200" class-name="vertical-center-modal" :width="840">
    ...
    methods: {
      ...
      listenSubEvent (isLoadingFun) {
        ...
        if (isSubmit) {
          ...
          isLoadingFun(true);
          let idArr = (this.formValidate.scriptList.map(item => item.id)).join(',');
