...
let evaluationManagementAddList = {
  remark: [baseRules.inputLen(0, 50), baseRules.illegalChar()], //,
  parentTitle: [baseRules.requiredNoEvent, baseRules.inputLen(0, 50), baseRules.illegalChar()], //,
  titleSub: [baseRules.requiredNoEvent, baseRules.inputLen(0, 50), baseRules.illegalChar()], //,
...
let laborManagement = {
  ...
  cardNo: baseRules.idNumber,
  jbrName: baseRules.requiredNoEvent,
  money:[baseRules.numberSection(1,99999999)],
}
