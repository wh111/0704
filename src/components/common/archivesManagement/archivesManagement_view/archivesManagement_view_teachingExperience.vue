...
<template>
  <div >
      ...
      <div class="table-wrapper-border">
        <el-row class="table-row-oddBg">
          <el-col :span="4"><div class="table-row-right">是否获得教学职称：</div></el-col>
          <el-col :span="3"><div class="table-row">{{formValidate.hasTeachTitle | typeText}}</div></el-col>
          ...
          <el-col :span="5"><div class="table-row">{{formValidate.hasTheoryTeach | typeText}}</div></el-col>
        </el-row >

        <el-row class="table-row-evenBg">
          <el-col :span="4" class="table-row-right">是否临床带教：</el-col>
          <el-col :span="3" class="table-row">{{formValidate.hasClinic | typeText}}</el-col>
        ...
        <el-row class="table-row-oddBg">
          ...
          <el-col :span="3"><div class="table-row">{{formValidate.hasTeachQualified | typeText}}</div></el-col>
          <el-col :span="3"><div class="table-row-right">是否院士：</div></el-col>
          <el-col :span="5"><div class="table-row">{{formValidate.hasAcademician | typeText}}</div></el-col>
          <el-col :span="4"><div class="table-row-right" style="line-height: inherit">是否国务院学科评议组成员：</div></el-col>
          <el-col :span="5"><div class="table-row">{{formValidate.hasCouncilMember | typeText}}</div></el-col>
        </el-row >
        ...
        <el-row class="table-row-oddBg">
          ...
          <el-col :span="3"><div class="table-row">{{formValidate.tutorType | typeText}}</div></el-col>
