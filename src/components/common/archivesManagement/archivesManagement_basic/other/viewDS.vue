  ...
  <el-form ref="formValidate" class="demo-form-inline" label-width="115px">
    ...
    <el-row>
      <el-col :span="24">
        ...
        <el-row :gutter="10" class="table-back-two">
          <el-col :span="8">
            <el-form-item label="学科专业：" prop="specialtyName">
              <el-input v-model="specialtyName" @change="setDataToParent" placeholder="请输入内容"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="职称：" prop="teachTitle">
              <el-select v-model="teachTitle" @change="setDataToParent" filterable placeholder="请选择">
          ...
          <el-col :span="8">
            <el-form-item label="博导/硕导：" prop="tutorType">
              <el-select v-model="tutorType" placeholder="请选择" @change="setDataToParent">
                <el-option
                  v-for="item in [{value:'BD',label:'博导'},{value:'SD',label:'硕导'}]"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value">
                </el-option>
        ...
        <el-row :gutter="10" class="table-back-one">
          <el-col :span="12">
            <el-form-item label="担任导师：" prop="serveTutor">
              <el-input type="textarea" :rows="2" @change="setDataToParent" placeholder="请输入内容"
                        v-model="serveTutor"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="主要研究方向：" prop="mobile">
              <el-input type="textarea" :rows="2" @change="setDataToParent" placeholder="请输入内容"
                        v-model="researchDirection"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       * */
      setDataToParent () {
        this.$emit('storeSubData', {
          teachTitle: this.teachTitle, //职称（导师）
          specialtyName: this.specialtyName, //	学科专业（导师）
          tutorType: this.tutorType, //	博导/硕导（导师）
          serveTutor: this.serveTutor, //	担任导师（导师）
          researchDirection: this.researchDirection, //	主要研究方向（导师）
        })
      }
    },
    watch: {
