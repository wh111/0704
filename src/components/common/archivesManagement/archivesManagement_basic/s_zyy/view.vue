        ...
        <el-row :gutter="10" class="table-back-two-d">
          <el-col :span="12">
            <el-form-item label="人员属性：" prop="rotaryZyytype">
              {{ formValidate.rotaryZyytype | dictionary(this, 'ROTARY_ZYY_TYPE') }}
            </el-form-item>
          </el-col>
          <el-col :span="12" class="editForm">
            <el-form-item label="培训方向：" prop="rotaryProclass">
              {{ formValidate.rotaryProclass | dictionary(this, 'ROTARY_PROCLASS') }}
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10" class="table-back-two-d">
          <el-col :span="12" class="editForm">
            <el-form-item label="培训年限：" prop="rotaryAdmrank">
              {{ formValidate.rotaryAdmrank || 0 }}年
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
  ...
  import api from '../../../../zyy/rdyEnrollEnroll/rdyPersonnelManagement/api';
