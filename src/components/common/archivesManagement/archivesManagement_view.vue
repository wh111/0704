...
<script>
  /*引入查看的子组件*/
//  引入--基本情况--组件
  import basic from './archivesManagement_view/archivesManagement_view_basic.vue';
//  引入--学历信息--组件
  import education from './archivesManagement_view/archivesManagement_view_education.vue';
//  引入--工作经历--组件
  import workExperience from './archivesManagement_view/archivesManagement_view_workExperience.vue';
//  引入--专业技术职称晋升情况--组件
  import professionalSkill from './archivesManagement_view/archivesManagement_view_professionalSkill.vue';
//  引入--资格证书取得情况--组件
  import credentials from './archivesManagement_view/archivesManagement_view_credentials.vue';
//  引入--教学经历--组件
  import teachingExperience from './archivesManagement_view/archivesManagement_view_teachingExperience.vue';
//  引入--学习培训情况--组件
  import study from './archivesManagement_view/archivesManagement_view_study.vue';
//  引入--培训考试、考核情况--组件
  import train from './archivesManagement_view/archivesManagement_view_train.vue';
//  引入--获奖情况--组件
  import awards from './archivesManagement_view/archivesManagement_view_awards.vue';
//  引入--科研信息--组件
  import scientific from './archivesManagement_view/archivesManagement_view_scientific.vue';
//  引入--证件复印件--组件
  import papers from './archivesManagement_view/archivesManagement_view_papers.vue';
