<template>
  <div>
    <selectSchool v-if="operailityData.types==='BKS'&&operailityData.parentId===-101" @edit="addCallBack(type)"
                  :type="type" @cancel="cancel" :operailityData="operailityData"></selectSchool>
    <div v-else>
