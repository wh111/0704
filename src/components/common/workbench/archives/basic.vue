...
<script>
  let Util = null;
  import otherBasicInput from '../../archivesManagement/archivesManagement_basic/other/input.vue'; // 其他人员
  import bksBasicInput from '../../archivesManagement/archivesManagement_basic/s_bks/input.vue'; // 本科生
  import jxsBasicInput from '../../archivesManagement/archivesManagement_basic/s_jxs/input.vue'; // 进修生
  import sxsBasicInput from '../../archivesManagement/archivesManagement_basic/s_sxs/input.vue'; // 实习生
  import yjsBasicInput from '../../archivesManagement/archivesManagement_basic/s_yjs/input.vue'; // 研究生
  import zyyBasicInput from '../../archivesManagement/archivesManagement_basic/s_zyy/input.vue'; // 住院医
  export default {
    //props接收父组件传递过来的数据
...
//          this.$emit(this.messTitle.type, this.messTitle.type, this.messTitle.successTitle);
