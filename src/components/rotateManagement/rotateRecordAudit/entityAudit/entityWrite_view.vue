      ...
      <el-row >
        <el-col :span="16" :offset="2">
          <el-form-item label="主要诊断:" prop="name" >
            <el-input type="textarea" readonly v-model="data.mainDiagnosis"></el-input>
          </el-form-item>
        </el-col >
      </el-row >
      ...
      <el-row >
        <el-col :span="16" :offset="2">
          <el-form-item label="次要诊断:" prop="name" >
            <el-input type="textarea" readonly v-model="data.secondaryDiagnosis"></el-input>
          </el-form-item>
        </el-col>
        </el-col >
      </el-row >
      ...
      <el-row >
        <el-col :span="16" :offset="2">
          <el-form-item label="转归情况:" prop="name" >
            <el-input type="textarea" readonly v-model="data.situation"></el-input>
          </el-form-item>
        </el-col>
        </el-col >
      </el-row >
...
//          ]
        ...
        listMessTitle:{
          ...
          ajaxParams:{
            url:this.url.diseaseRecordGet+this.operailityData.diseaseId,
          }
        }
      }
    },
