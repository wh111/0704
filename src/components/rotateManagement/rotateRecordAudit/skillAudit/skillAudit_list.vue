...
<template>
  <div id="content" ref="content" class="modal">
    ...
    <Modal
      ...
      <add v-if="addModal" @cancel="cancel" @updata="updataCallback" @add="subCallback"
           :operaility-data="operailityData" :url="url"></add>
      <div slot="footer"></div>
    </Modal>
    <!--修改-->
    <Modal
      ...
      <edit v-if="editModal" @cancel="cancel" whereFrom="audit" @edit="subCallback" :operaility-data="operailityData"
            :url="url"></edit>
      <div slot="footer"></div>
    </Modal>
    <!--审核-->
    <Modal
      ...
      <audit v-if="auditModal" @cancel="cancel" @audit="subCallback" :operaility-data="operailityData"
             :url="url"></audit>
      <div slot="footer"></div>
    </Modal>
    <!--删除弹窗-->
    <Modal
      ...
      <remove v-if="removeModal" :delete-url="url.diseaseRemove" @remove="subCallback" @cancel="cancel"
    ...
    <Modal
      ...
      <operate v-if="passModal" :type="'pass'" :operate-url="url.skillRecordManageModifySubPass" :methods="'post'"
    ...
    <Modal
      ...
      <operate v-if="rejectModal" :type="'reject'" :operate-url="url.skillRecordManageModifySubReject"
               :operateData="passData" :methods="'post'" @cancel="cancel" @operate="subCallback"
               :operaility-data="operailityData"></operate>
      <div slot="footer"></div>
    </Modal>
...
<script>
  ...
  //引入--修改--组件
  import edit from '../../rotateRecordWrite/skillWrite/skillWrite_edit.vue'
  //当前组件引入全局的util
  let Util = null
  export default {
    data() {
      return {
        ...
        listMessTitle: {
          ...
          ajaxParams: {
            url: url.skillRecordManagePagelist,
            params: {}
          }
        },
        /*--按钮button--*/
        ...
        rejectOneId: {id: 'rejectOneId', title: '驳回'},
    ...
    methods: {
      ...
      reported (data) {
        this.reportedUrl = url.diseaseModifyRelease + '/' + data.skillId
