      ...
      <el-row >
        <el-col :span="16" :offset="2">
          <el-form-item label="成功:" prop="name" >
            {{formValidate.isSuccess | typeText}}
          </el-form-item>
        </el-col >
      </el-row >
      <el-row >
...
<script>
  ...
  export default {
    ...
    data (){
      return{
        ...
        addMessTitle:{
          ...
          ajaxError:'ajaxError',
          ajaxParams:{
            url:url.skillRecordManageModifyState+this.operailityData.skillId,
            method:'post',
            data:{},
          }
        },
        ...
        getMessTitle:{
          ...
          ajaxParams:{
            url:url.skillRecordGet+this.operailityData.skillId,  //向后台请求数据的地址
    ...
    created(){
      ...
      this.listMessTitle.ajaxParams.url = url.userRotaryDeptlist+'SXS-'+userInfo.id;
...
//          reviewMess
      ...
      podIdChange(val){
        let listMessTitle={
          ...
          ajaxParams:{
            url:url.getMyRotaryRequirements+'bz-'+val,
          }
        }
