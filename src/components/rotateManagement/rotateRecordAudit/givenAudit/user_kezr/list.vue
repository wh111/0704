      ...
      <el-table align="center" :context="self" :height="dynamicHt" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="200" align="center">
          <template scope="scope">
            ...
            <el-button :disabled="scope.row.graduateAppraisalState!=='EDU_NOT_REPORT'" size="small" type="success" @click="rotary(scope.row)">审核</el-button>
        ...
        <el-table-column label="是否报到" prop="isRegister" show-overflow-tooltip></el-table-column>
        <el-table-column label="出科鉴定状态" prop="graduateAppraisalStateStr" show-overflow-tooltip></el-table-column>
      </el-table>
    </div>
    <!-- 分页按钮 -->
