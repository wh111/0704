...
<template>
  <div id="content" ref="content" class="modal">
      ...
      <el-row style="margin-bottom:0">
        ...
        <el-col :span="14"  align="right">
          <el-form-item label="创建人姓名" prop="createUserName">
            <el-input style="width:300px;" v-model="formValidate.createUserName" placeholder="输入创建人姓名搜索">
    ...
    <Modal
      ...
      <operate v-if="passModal" :type="'pass'" :operateData="passData" @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
    ...
    <Modal
      ...
      <operate v-if="rejectModal" :type="'reject'"  :operateData="rejectData"   @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
    <!---->
  </div>
...
<script>
  ...
  //引入--新建--组件
  //引入--修改--组件
  import audit from "./operationAudit_audit.vue";
  //引入--查看--组件
  import show from "./operationAudit_view.vue";
  ...
  export default{
    data() {
      return {
        ...
        passData:{
          url:url.operationModifyState.path,
          data:{state:'PASS',reviewMess:'批量审核通过'}
        },
        rejectData:{
          url:url.operationModifyState.path,
          data:{state:'REJECT',reviewMess:'批量审核驳回'}
        },
...
//          }
        ...
        listMessTitle:{
          ...
          ajaxParams:{
            url:url.operationManageList.path,
            params:{}
          }
        },
        /*--按钮button--*/
