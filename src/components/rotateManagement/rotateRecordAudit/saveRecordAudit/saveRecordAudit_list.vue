...
<template>
  <div id="content" ref="content" class="modal">
    ...
    <Modal
      ...
      <operate v-if="passModal" :type="'pass'" :operate-url="url.rescuePatientRecordModifySubPass" :methods="'post'"  @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
    ...
    <Modal
      ...
      <operate v-if="rejectModal" :type="'reject'" :operate-url="url.rescuePatientRecordModifySubReject" :methods="'post'"  @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
    <!---->
  </div>
...
<script>
  ...
  import url from '../api'
  //引入--修改--组件
  import audit from "./saveRecordAudit_audit.vue";
  //引入--查看--组件
  import show from "./saveRecordAudit_view.vue";
...
//          }
        ...
        listMessTitle:{
          ...
          ajaxParams:{
            url:url.rescuePatientRecordMangePageList,
            params:{}
          }
        },
        /*--按钮button--*/
