  ...
  <div id="content" ref="content" class="modal">
    <el-form   ref="formValidate" :model="formValidate" :rules="largeCaseWriteList" inline label-width="100px">
      <el-row style="margin-bottom:0">
        <!--列表操作按钮-->
        <el-col :span="10" >
         <el-button type="primary" v-if="type !='classicCase'" @click="pass">批量通过</el-button>
          <el-button type="danger" v-if="type !='classicCase'" @click="reject">批量驳回</el-button> &nbsp;
        </el-col>
        <!--搜索项-->
      ...
      <div v-if="searchMore" ref="searchMore" align="right">
        ...
        <!--<el-form-item v-if="type !='classicCase'" label="病例类型:"  prop="title">-->
          <!--<el-select v-model="formValidate.classicCase" placeholder="请选择状态">-->
            <!--<el-option label="全部" value=""></el-option>-->
            <!--<el-option label="经典" value="classic"></el-option>-->
            <!--<el-option label="非经典" value="noclassic"></el-option>-->
          <!--</el-select>-->
        <!--</el-form-item>-->
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template scope="scope">
              ...
              <!-- <el-button v-if="type !='classicCase'&&scope.row.cstate != 'PASS' && scope.row.cstate != 'REJECT'"
                          size="small" @click="edit(scope.row)">修改
               </el-button>-->
              <el-button  v-if="type !='classicCase'&&scope.row.cstate != 'PASS' && scope.row.cstate != 'REJECT'"  size="small" @click="audit(scope.row)">审核</el-button>
              <el-button v-if="scope.row.cstate != 'PASS' && scope.row.cstate != 'REJECT' && scope.row.ctype == 'DBL'"
                         size="small" @click="postil(scope.row)">批注
              </el-button>
            </template>
          </el-table-column>
          <el-table-column
    ...
    <Modal
      ...
      <edit v-if="auditModal" @cancel="cancel"  @audit="subCallback"  :operaility-data="operailityData"></edit>
      <div slot="footer"></div>
    </Modal>
    <!--修改-->
    <Modal
      ...
      <edits v-if="editModal" whereFrom="audit" @cancel="cancel" @edit="subCallback" :operaility-data="operailityData"
             :url="url"></edits>
      <div slot="footer"></div>
    </Modal>
    ...
    <Modal
      ...
      <operate v-if="passModal" :type="'pass'" :operate-url="url.caseRecordManageBigCasesReviews"   @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
    ...
    <Modal
      ...
      <operate v-if="rejectModal" :type="'reject'" :operate-url="url.caseRecordManageBigCasesRejects"   @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
...
<script>
  ...
  import url from '../api'
  //引入--修改--组件
  import edits from '../../rotateRecordWrite/largeCaseWrite/largeCaseWrite_edit'
