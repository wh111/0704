      ...
      <el-row>
        <el-col :span="16" :offset="2">
          <el-form-item label="轮转开始日期:" >
            {{formValidate.rtStartTime===null||formValidate.rtStartTime==''?'':formValidate.rtStartTime}}
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="16" :offset="2">
          <el-form-item label="轮转结束日期:" >
            {{formValidate.rtEndTime===null||formValidate.rtEndTime==''?'':formValidate.rtEndTime}}
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="16" :offset="2">
          <el-form-item label="相关证明材料:" >
            <upload-file :uploadFiles="formValidate.delayGivenFiles" :show="true"></upload-file>
          </el-form-item>
        </el-col>
      </el-row>
