  ...
  <div id="content" ref="content" class="modal">
    <el-form   ref="formValidate" :model="formValidate" :rules="largeCaseWriteList" inline label-width="80px">
      <el-row style="margin-bottom:0">
        <!--列表操作按钮-->
        <el-col :span="10" >
          <el-button type="primary" v-if="type !='classicCase'" @click="add">添加</el-button>
          <!--<el-button type="danger" v-if="type !='classicCase'" @click="remove">删除</el-button>-->
          <!--<el-button size="small" v-if="type !='classicCase'" :disabled="style.isclassicCase" type="primary" @click="classicCase">设置为经典病例</el-button>-->
        </el-col>
        <!--搜索项-->
    ...
    <Modal
      ...
      <remove  v-if="removeModal" :delete-url="url.caseRecordBigCasesDelete" @remove="subCallback" @cancel="cancel" :operaility-data="operailityData"></remove>
    ...
    <Modal
      ...
      <operate  v-if="reportedModal" :type="'reported'" :operate-url="url.caseRecordBigCasesRelease" @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" :url="url"></operate>
      <div slot="footer"></div>
    </Modal>
...
<script>
  ...
  import url from '../api'
  //引入--新建--组件
  import add from "./largeCaseWrite_add.vue";
  //引入--修改--组件
  import edit from "./largeCaseWrite_edit.vue";
  //引入--查看--组件
...
//          }
    ...
    methods: {
      ...
      remove(){
        ...
        if(!(['NO_SUBMIT'].includes(this.multipleSelection[0].cstate ) )) {
