...
<template>
  <div id="content" ref="content" class="modal">
    <el-form  ref="formValidate" :model="formValidate" :rules="entityWriteList" inline label-width="100px">
      <el-row style="margin-bottom:0">
        ...
        <el-col :span="14"  align="right">
          <el-form-item  label="病种名称:" prop="diseaseName">
            <el-input   v-model="formValidate.diseaseName" placeholder="输入病种名称搜索">
...
<script>
  ...
  import url from '../api'
  //引入--新建--组件
  import add from "./entityWrite_add.vue";
  //引入--修改--组件
  import edit from "./entityWrite_edit.vue";
  //引入--查看--组件
  ...
  export default{
    ...
    methods: {
      ...
      remove(){
        ...
        this.operailityData = [{id:this.multipleSelection[0].diseaseId}];
