      ...
      <!--<el-col :span="20"  :offset="1">-->
        <!--<el-form ref="formValidate" inline label-width="100px" class="demo-ruleForm">-->
          <!--<el-form-item  prop="title">-->
            ...
            <!--</el-input>-->
          <!--</el-form-item>-->
          <!--&lt;!&ndash;<el-form-item  prop="title">&ndash;&gt;-->
          <!--&lt;!&ndash;<el-input   v-model="formValidate.userName" placeholder="输入类型搜索">&ndash;&gt;-->
...
<script>
  /*当前组件必要引入*/
  import show from '../../largeCaseWrite/largeCaseWrite_view/view_largeCaseTemplate.vue'
  //引入--新建教学活动--组件
  let Util=null;
  export default {
    props:['url'],
    data() {
      return {
        ...
        listMessTitle: {
          ...
          ajaxParams: {
            url: this.url.caseRecordPagelist,
            params: {},
          }
        },
