...
<template>
    <div id="content" ref="content" >
      ...
      <Modal
        ...
        <operate v-if="reportedModal" :type="'reported'" :operateUrl="url.thematicReviewModifySubmit"   @operate="subCallback" @cancel="cancel" :operaility-data="[formValidate]"></operate>
        <div slot="footer"></div>
      </Modal>
      <!---->
      </div>
...
<script>
  ...
  import viewUEditor from '../../../common/showUeditor.vue';
    ...
    import url from '../api'
    /*当前组件必要引入*/
    import add from './monographReviewWrite_add.vue';
    import edit from './monographReviewWrite_edit.vue';
    //当前组件引入全局的util
    let Util = null;
    export default{
        data() {
