...
<template>
  <div id="content" ref="content" class="modal">
    ...
    <Modal
      ...
      <remove  v-if="removeModal" :delete-url="url.rescuePatientRecordDelete" @remove="subCallback" @cancel="cancel" :operaility-data="operailityData"></remove>
    ...
    <Modal
      ...
      <operate v-if="reportedModal" :type="'reported'" :operateUrl="url.rescuePatientRecordModifySubmit"   @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
      <div slot="footer"></div>
    </Modal>
    <!---->
  </div>
...
<script>
  ...
  import url from '../api'
  //引入--新建--组件
  import add from "./saveRecordWrite_add.vue";
  //引入--修改--组件
  import edit from "./saveRecordWrite_edit.vue";
  //引入--查看--组件
  import show from "./saveRecordWrite_view.vue";
...
/*          {
        ...
        listMessTitle:{
          ...
          ajaxParams:{
            url:url.rescuePatientRecordPageList,
            params:{}
          }
        },
        /*--按钮button--*/
