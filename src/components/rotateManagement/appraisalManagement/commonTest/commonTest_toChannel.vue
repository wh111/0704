<template>
  ...
  <div>
    ...
    <el-row class="but-space">
      ...
      <el-col :span="16">
        <p>上传填好的公共课考核信息表 ( 仅支持.xls/.xlsx格式)</p>
        </br>
    ...
    <Modal close-on-click-modal="false" width="1100" v-model="toChannelModal" title="对话框标题" class-name="vertical-center-modal">
      ...
      <to-channel v-if="toChannelModal" @cancel="closeChannel" :url="url.commonsCourseImport.path" @success="subHandelEvent" :data="convertedData"
...
//          "参培年份": "rotaryYear",
    ...
    mounted() {
      ...
      this.http = http + 'static/template/公共课考核信息模板.xls';
      this.init();
    },
    methods: {
      /*
