  ...
  <div id="content" ref="content" class="modal">
    <el-form  ref="formValidate" :model="formValidate" :rules="rules" inline label-width="130px">
      <el-row style="margin-bottom:0">
        <!--列表操作按钮-->
        <el-col :span="10" >
          <el-button type="primary" @click="toChannel">从Excel导入考核成绩</el-button>
...
<script>
  ...
  import url from '../api'
  //引入--导入--组件
  import toChannel from "./completionOfTheInspection_toChannel.vue";
...
//        url.examineExport.path
        ...
        return config.urlPrefix+url.examineExport.path+'?'+path
      },
    },
    mounted(){
      //页面dom稳定后调用
