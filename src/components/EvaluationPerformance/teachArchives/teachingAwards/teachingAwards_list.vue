...
<template>
  <div class="teachingConstruction-list">
    ...
    <tableItems :operaility-data="operailityData2" :url="url"></tableItems>
  </div>
</template>

<script>
  import tableItem from '../table_itemCompetition';
  import tables from '../table_itemHonor';
  import tableItems from '../table_itemGuidance';
  import url from '../teachingConstruction/api';

  let Util = null;
  export default {
    name: 'teachingAwards_list',
    data () {
      return {
        url: url,
        operailityData: {
          ...
          lists: [
            {
              ...
              'teachPropertyTwo': '',
              'createTime': '',
              'type': 'teaching_reward_competition',
            }],
        },
        operailityData2: {
          title: '指导学生参与竞赛',
