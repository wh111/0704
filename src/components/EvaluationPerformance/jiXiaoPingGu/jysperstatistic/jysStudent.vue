  ...
  <div id="content" ref="content" class="modal">
    ...
    <div style="border: 1px solid #dfe6ec">
      ...
      <div class="inStudyRegister tr-count-child"
           :style="{overflow: 'auto',height:dynamicHt+'px'}">
        <table ref="myTable" class="el-table">
          ...
          <tbody>
          <tr v-for="(item,index) in listData" v-if="listData.length">
...
<script>
  /*当前组件必要引入*/
  import api from './api';
  import show from './jysperstatistic_view'
  //当前组件引入全局的util
  let Util = null
  export default {
    name: 'jysStudent',
