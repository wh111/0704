...
<script>
  ...
  let Util = null;
  export default {
    name: 'perstudent_yjszyxw',
    data () {
      return {
        viewTypes: 'yjszyxw', // 视图类型
        treeDefaults: {
          getTreeUrl: '/examination/achievetree/tree?code=' + 'student_yjszyxw',
          getDataUrl: '',
          isShowMenus: true
        },
        fromWhereTreeType: 'student_yjszyxw',
        //查询表单
