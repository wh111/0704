...
* @description 工作坊-修改页面,用于湘雅三院会议直播
      ...
      <el-row >
        <el-col :span="23" :offset="1">
          <el-form-item label="工作坊简介：" prop="summary"  style="width: 820px">
            <viewUEditor style="width:700px;" v-if="isGetSuccess" :name="'ud1'" @storeUE="storeUE" @getUeditorVal="getUeditorVal" :ueditor-val="ueditorVal" :ueditor-config="ueditorConfig"></viewUEditor>
          </el-form-item>
        </el-col >
      </el-row >
    </el-form>
    ...
    data (){
      return{
        ...
        editMessTitle:{
          ...
          ajaxError:'ajaxError',
          ajaxParams:{
            url: api.workshopsModify.path+this.operailityData.workshopsId,
            method: api.workshopsModify.method,
            jsonString:true,
          }
        },
