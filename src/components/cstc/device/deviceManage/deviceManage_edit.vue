      ...
      <el-form :model="formValidate" ref="formValidate" :rules="rules" label-width="100px">
        ...
        <el-col :span="20" :offset="2">
          <el-form-item type="附件" label="多媒体文件:" class="feildFontweight">
            <upload-file :accept="'mp4,flv,rmvb,rm,avi'" :noFirstCallBack="true" :uploadUrl="url.multimedia.path" :size="500*1024" :uploadFiles="videoList"
                         @setUploadFiles="setMultimediaFileIds"></upload-file>
          </el-form-item>
        </el-col>
        <el-col :span="20" :offset="2">
          <el-form-item label="附件:" class="feildFontweight">
            <upload-file :size="500*1024" :uploadFiles="formValidate.fileList||[]"
                         @setUploadFiles="setUploadFiles"></upload-file>
          </el-form-item>
        </el-col>
        <el-col :span="20" :offset="2">
