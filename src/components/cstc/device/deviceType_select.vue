  ...
  <div>
    <layout-tree style="height:500px;" ref="selectContent">
      ...
      <div slot="right" id="content" ref="content" class="modal" style="padding:0;">
        ...
        <!-- 表格数据 -->
        <div class="deviceSelectTypeTable" ref="deviceTable">
          <el-table align="center" ref="multipleTable" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark" style="width: 100%"
...
//            reserveTimeSetId: this.timeData.reserveTimeSetId,
      ...
      setTableData () {
        ...
        this.queryQptions.params.status = 'NORMAL';
        this.ajax({
