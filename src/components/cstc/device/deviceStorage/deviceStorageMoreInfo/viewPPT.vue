...
<template>
  <div>
    ...
    <div class="swiper-img-body" style="width: 100%;">
      <div class="swiper-img-box">
        <div class="swiper-img-left" style="width: 440px;height:250px">
          <swiper :options="swiperOption1" ref="mySwiper1">
            <!-- slides -->
            <swiper-slide v-for="(item,index) in imagesList" :key="index">
              <img width="100%" height="250" :src="item.src"/>
            </swiper-slide>
            <swiper-slide v-for="(item,index) in imagesList" :key="index">
              <img width="100%" height="250" :src="item.src"/>
            </swiper-slide>
        ...
        <div class="swiper-img-right" style="height:250px">
