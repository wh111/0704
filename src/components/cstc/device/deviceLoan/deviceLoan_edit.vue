<template>
  <!-- 修改借用记录 -->
  <div class="editForm">
    <el-form :model="formValidate" ref="formValidate" label-width="100px" :rules="rules">
      <el-row>
    ...
    methods: {
      ...
      listenSubEvent(isLoadingFun) {
        ...
        if (isSubmit) {
          ...
          // let selectData = this.selectObj[this.selectIndex || 0].deviceList[this.selectTypeIndex || 0];
