<template>
  ...
  <div>
    ...
    <el-row class="but-space">
      ...
      <el-col :span="16">
        <p>上传填好的人员与IC卡信息表 ( 仅支持.xls/.xlsx格式)</p></br>
    ...
    <Modal
      ...
      <to-channel v-if="toChannelModal" @cancel="closeChannel" url="card/reader/user/excelImport/save"
                  @success="subHandelEvent" :data="convertedData" :format="format"></to-channel>
      <div slot="footer"></div>
    </Modal>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        toChannelId: {id: 'toChannelId', title: '人员与IC卡信息表'},
        convertedData: {},
        format: {
          '编号': 'userNum',
          '姓名': 'userName',
...
//          },
    ...
    mounted() {
      ...
      this.http = http + 'static/template/人员IC卡信息.xls';
      this.init();
    },
    methods: {
      /*
