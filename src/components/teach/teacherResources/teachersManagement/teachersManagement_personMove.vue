<!----------------------------------
****--师资管理-人事调动(personMove)
****--@date     2018/11/29
****--@author   ls<1850335617@qq.com
----------------------------------->
<template>
  <div>
    <el-form :model="formValidate" :rules="personMoveUser" ref="formValidate" label-width="90px">
      <el-row :gutter="20">
...
<script>
  let Util = null;
  import {personMoveUser} from "../../rules.js";
  export default {
    name: 'person-move',
    ...
    data(){
      return {
        ...
        treeDefaults: this.parentTreeDefaults || {
          getTreeUrl: '/teacherType/tree?rootId=-1',
          getDataUrl: '',
          isShowMenus: false,
    ...
    methods: {
      ...
      searchUsersData(id) {
        ...
        let userList = {
          ...
          ajaxParams: {
            url: '/archives/query/teach',
            params: {}
          }
        }
        this.userListData.typeId = id;
        Object.assign(userList.ajaxParams.params, this.userListData);
        this.ajax(userList);
      },
      ...
      listenSubEvent(isLoadingFun){
        ...
        if(isSubmit) {
          ...
          this.addMessTitle.ajaxParams.url = '/archives/teachMobilize/' + targetDepId + '?userIds=' + userIds
