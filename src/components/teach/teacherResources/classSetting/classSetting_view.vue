    ...
    <el-form class="demo-form-inline">
      ...
      <el-row>
        <el-col :span="24">
          ...
          <!--表格数据-->
          <el-table border align="center" :data="tableData" tooltip-effect="dark" highlight-current-row style="width: 100%">
            <el-table-column prop="name" label="职称" width="170" align="center">
              <template scope="scope">
                {{ scope.row.teachLevel }}
              </template>
            </el-table-column>
