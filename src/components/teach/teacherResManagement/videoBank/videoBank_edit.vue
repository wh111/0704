      ...
      <el-row v-if="!unFile">
        <el-col :span="16" :offset="2">
          <el-form-item label="视频文件:" prop="fileId">
            <up-file-new :noFirstCallBack="true" :length="1" :uploadFiles="videoFiles" :unSize="true"
                         :accept="'mp4|webm|ogg'" @setUploadFiles="expenseFileEvent"></up-file-new>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-if="!unLogo">
        <el-col :span="16" :offset="2" prop="logoPath" >
          <el-form-item label="封面:" >
            <img-wall  :fileList="logoFiles"  :onlyOnePic="true" @upladSuccess="expenseLogoEvent"></img-wall>
          </el-form-item>
        </el-col>
      </el-row>
