<template>
  <div>
    <el-form :model="formValidate" :rules="videoBank"  ref="formValidate" label-width="90px">
      ...
      <el-row>
        <el-col :span="20" :offset="2">
          <el-form-item label="名称:" prop="name">
            <el-input :disabled="true" v-model="formValidate.name" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="20" :offset="2">
          <el-form-item label="简介:" prop="remark">
            <el-input :disabled="true" type="textarea"  v-model="formValidate.remark" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-if="!unFile">
        <el-col :span="16" :offset="2">
          <el-form-item label="视频文件:" prop="fileId">
            <up-file-new :noFirstCallBack="true" :show="true" :length="1" :uploadFiles="videoFiles" :unSize="true"
                         :accept="'mp4|webm|ogg'"></up-file-new>
          </el-form-item>
        </el-col>
      </el-row>

      <el-row v-if="!unLogo">
        <el-col :span="16" :offset="2" prop="logoPath" >
          <el-form-item label="封面:" >
            <img style="width: 140px;height: 120px" v-for="item in logoFiles" :src="item.url" alt="">
            <!--<img-wall  :fileList="logoFiles"  :onlyOnePic="true" ></img-wall>-->
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <!--<img-wall  :fileList="imgFiles"   @upladSuccess="expenseImgsEvent"></img-wall>-->
      <!--</el-form-item>-->
      <!--</el-col>-->
      <!--</el-row>-->
    </el-form>
  ...
  export default{
    ...
    methods: {
      ...
      getListData(res){
        ...
        if(data.imgsPath){
          let imgsPath = data.imgsPath.split(',');
          //其他图片
          let imgFiles = [];
