      ...
      <el-row v-if="!unFile">
        <el-col :span="16" :offset="2">
          <el-form-item label="资源文件:"  prop="fileId" >
            <up-file-new :unSize="true" :noFirstCallBack="true" :length="1" :show="true" :uploadFiles="fileList" :accept="'doc|docx|xls|xlsx|ppt|pptx|pdf'" @setUploadFiles="expenseFileEvent"></up-file-new>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
