      ...
      <el-col :span="11" :offset="2">
        <el-form label-width="90px">
          <el-form-item label="资源文件:" class="hide-name">
            <img style="width: 120px;height: 100px" v-for="item in getFileList" :src="item.filePath">
            <!--<up-file-new :unSize="true" :show="true"  :uploadFiles="getFileList"   :type="'picture'"   @setUploadFiles="expenseFileEvent"></up-file-new>-->
          </el-form-item>
        </el-form>
      </el-col>
      ...
      <el-col style="" :span="6" >
        <div  v-for="(item,index) in fileList" :key="index" style=" height: 92px;line-height:92px;margin-top: 10px;margin-left:-100px">
          <el-form  :model="item" :rules="resMedicalAtlas" ref="formValidate" label-width="90px">
            <el-form-item label="简介:" prop="remark" >
              <el-input :disabled="true" v-model="item.remark"></el-input>
            </el-form-item>
          </el-form>
        </div>
      </el-col>
      ...
      <el-row v-if="!unLogo">
        <el-col :span="16" :offset="2">
          <el-form-item label="封面:">
            <img style="width: 140px;height: 120px" v-for="item in getLogoFile" :src="item.url" alt="">
