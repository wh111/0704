...
<template>
    <div ref="treeContent">
        <layout-tree :style="{'height':contenHeight + 'px'}">
            <left-tree slot="left" @setCurrSltNodeId="setTreeDepId" @tree-click="treeClick"
            ...
            <div slot="right" id="content" ref="content">
                    ...
                    <el-row style="padding-bottom:20px;">
                        ...
                        <el-col :span="10" align="right">
                            <el-form-item label="名称:" prop="title">
                                <el-input placeholder="名称" v-model="formValidate.title" style="width:300px;"
                                          :maxlength="51">
                ...
                <!-- 数据表格 -->
                <div ref="tableView">
                    <el-table @selection-change="handleSelectionChange" align="center" :context="self"
                              :height="tableHeight" :data="tableData" tooltip-effect="dark" style="width: 100%">
                        ...
                        <el-table-column label="操作" align="center" width="140">
                            <template scope="scope">
                                ...
                                <el-button
                                        v-if="scope.row.publishStatus == 'UNPUBLISH' && scope.row.auditStatus == 'AUDIT_SUCCESS'"
                                        :disabled="scope.row.auditStatus == 'AUDIT_FAILURE'" size="small" type="info"
                                        @click="modify(scope.row)">修改
                                </el-button>
                                <el-button v-else
                                           :disabled="scope.row.publishStatus == 'PUBLISH' ||scope.row.auditStatus == 'AUDIT_FAILURE' "
                                           size="small" type="primary" @click="edit(scope.row)">修改
                                </el-button>
        ...
        <Modal
            ...
            <edit v-if="editModal" :id="deptId" :name="typeName" :fromWhereTree="fromWhereTree" @cancel="cancel"
                  @edit="subCallback" :url="url" :operaility-data="operailityData"></edit>
            <div slot="footer"></div>
        </Modal>
        <!---->
        <!--修改浏览次数弹窗-->
        ...
        >
            ...
            <modify v-if="modifyModal" :id="deptId" :name="typeName" :fromWhereTree="fromWhereTree" @cancel="cancel"
                    @modify="subCallback" :url="url" :operaility-data="operailityData"></modify>
            <div slot="footer"></div>
        </Modal>
        <!--增加弹窗-->
        <Modal
            ...
            <add v-if="addModal" :id="deptId" :name="typeName" :fromWhereTree="fromWhereTree" :url="url"
                 @cancel="cancel" @add="subCallback" :operaility-data="operailityData"></add>
            <div slot="footer"></div>
        </Modal>
        <!---->
        <!--查看弹窗-->
        ...
        >
            ...
            <jurisdiction v-if="jurisdictionSetModal" :id="deptId" :name="typeName" @jurisdictionSet="subCallback"
                          :url="url" @cancel="cancel" :operaility-data="operailityData"></jurisdiction>
            <div slot="footer"></div>
        </Modal>
        <!--批量审核-->
        <Modal
        ...
        >
            ...
            <audit v-if="auditModal" :fromWhereTree="fromWhereTree" @audit="subCallback" @cancel="cancel" :url="url"
        ...
        <Modal
            ...
            <operate v-if="publishModal" :type="'publish'" :methods="'post'" :operate-data="publishData"
        ...
        <Modal
            ...
            <operate v-if="revocationModal" :type="'revocation'" :operate-data="revocationData" @operate="subCallback"
...
<script>
    ...
    import add from "./resMedicalAtlas_add.vue";
    import edit from "./resMedicalAtlas_edit.vue";
        ...
        methods: {
            ...
            publish() {
                ...
                for(let i = 0; i < this.multipleSelection.length; i++) {
                    ...
                    if(this.multipleSelection[i].auditStatus == 'NOT_AUDIT') {
                        this.errorMess('待审核的不可以发布');
                        return;
                    }
                }
                this.operailityData = this.multipleSelection;
