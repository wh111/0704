...
<script>
  ...
  import add from "./resCaseLibraryTree_add.vue";
  import edit from "./resCaseLibraryTree_edit.vue";
  import show from "./resCaseLibraryTree_view.vue";
