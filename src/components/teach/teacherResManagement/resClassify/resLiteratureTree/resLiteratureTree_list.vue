...
<script>
  ...
  import add from "./resLiteratureTree_add.vue";
  import edit from "./resLiteratureTree_edit.vue";
  import show from "./resLiteratureTree_view.vue";
