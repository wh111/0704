...
<script>
  ...
  import add from "./resMedicalAtlasTree_add.vue";
  import edit from "./resMedicalAtlasTree_edit.vue";
  import show from "./resMedicalAtlasTree_view.vue";
  ...
  export default{
    ...
    methods: {
      ...
      add(){
        ...
        this.operailityData = {parentName:this.depDetails.name,parentId:this.deptId,types:this.types};
        this.openModel('add') ;
      },
      /*--点击--删除--按钮--*/
      remove(index){
