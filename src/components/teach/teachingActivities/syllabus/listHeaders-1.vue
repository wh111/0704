      ...
      >
        <div class="showCurrMess">
          <div v-for="(item,index) in data">
            ...
            <el-row :gutter="20" class="row-bg">
              <el-col :span="6"><p><strong>参加主体对象:</strong> {{data.participantSubject | participantSubject}} </p></el-col>
            </el-row>
            <el-row :gutter="20" class="row-bg">
            ...
            <el-row  class="row-bg">
              ...
              <el-col :span="18"><upload-file  :show="true" :uploadFiles="item.activityFileList"></upload-file></el-col>
            </el-row>
            </br>
            <hr>
            </br>
