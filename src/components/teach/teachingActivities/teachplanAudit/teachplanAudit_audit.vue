...
<template>
  <div>
    <show v-if="!type" :operailityData="operailityData" :url="url"></show>
    <el-form ref="formValidate" :model="formValidate"
             class="form-inline lose-margin" label-width="80px">
      <el-row>
      ...
      <el-row>
        <el-col :span="20" :offset="2">
          <el-form-item label="审核意见">
            <el-input type="textarea" v-model="formValidate.reviewMess"
                      :rows="6"
...
<script>
  //当前组件引入全局的util
  import show from './teachplanAudit_view'
    ...
    data () {
      return {
        ...
        saveCourseTitle: {
          ...
          ajaxError: 'ajaxError',
          ajaxParams: {
            url: this.url.teachplanAudits.path + '/' +
            this.operailityData.activityPlanId,
            method: this.url.teachplanAudits.method,
          },
        },
      }
    },
