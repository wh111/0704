...
<template>
  <div id="content" ref="content" class="modal">
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template scope="scope">
              ...
              <el-button type="info" size="small" :disabled="!scope.row.assigned" @click="xdth(scope.row)">心得体会</el-button>
              <el-button v-if="!scope.row.evaluateInfoResult" type="warning" :disabled="true" size="small">评价</el-button>
              <el-button v-else-if="!scope.row.evaluateInfoResult.totalScore" type="warning"  size="small" @click="evaluation(scope.row.evaluateInfoResult,'noScoreList')">评价</el-button>
              <el-button v-else type="info" size="small" @click="evaluation(scope.row.evaluateInfoResult,'haveScoreList')">查看评价</el-button>
            </template>
          </el-table-column>
          <el-table-column
            prop="activityName"
    ...
    <Modal
      ...
      <evaluate v-if="evaluationModal" :type="evaluationType" @cancel="evaluationModal=false" @add="evaluationCallback" :operaility-data="operailityData" ></evaluate>
      <div slot="footer"></div>
    </Modal>
  </div>
</template>
