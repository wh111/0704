...
<script>
  ...
  import url from '../app'
  /*---引入基本信息-----*/
  import baseInfo from  './evaluationActivitySet_add/add_baseInfo.vue'
  /*---引入设置评价关系-----*/
    ...
    data() {
      return {
        ...
        formValidate:{
          ...
          appraiserType:'PART',       //评价对象类型 当 评价人与被评价对象关系 选择 无直接关系(NO) 或者 本部门或本科室(DEPT) 时，该项必填。
          ...
          evaluatedType:'PART',       //被评对象类型 当 评价人与被评价对象关系 选择 无直接关系(NO) 或者 本部门或本科室(DEPT) 时，该项必填。
