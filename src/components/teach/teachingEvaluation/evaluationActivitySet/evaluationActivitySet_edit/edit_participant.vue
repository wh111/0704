...
<template>
  <div ref="content">
        ...
        <el-col :span="20"  :offset="1">
          <fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box" style="height: 300px">
              <left-tree :currentKey="formValidate.curAppraiserDept" @tree-click="appraiserTree" @setCurrSltNodeId="appraiserCurrSltNodeId" :treeOptions="treeOptions"> </left-tree>
            </div>
          ...
          <!--<fieldset class="layui-elem-field">-->
            <!--<legend>被评价人</legend>-->
            <!--<div class="layui-field-box" style="height: 300px">-->
              <!--<left-tree :currentKey="formValidate.curEvaluatedDept" @tree-click="evaluatedTree" @setCurrSltNodeId="evaluatedCurrSltNodeId" :treeOptions="treeOptions"> </left-tree>-->
            <!--</div>-->
          <!--</fieldset>-->
        </el-col>
      </el-row>
    ...
    <div>
      ...
      <!--</div>-->
      <modal-header slot="header" :content="selectUserId"></modal-header>
      <select-user v-if="evaluatedPartModal"   @cancel="cancel"   @setUsers="setEvaluatedPart" :unSelect="unSelect.evaluated" :initUser="formValidate.evaluatedPart"></select-user>
      <div slot="footer"></div>
      </Modal>
...
<script>
  ...
  let Util=null;
  export default {
    props:['url','operailityData','appraiserRole','evaluatedRole'],
    data() {
      return {
        treeOptions:{
        ...
        formValidate:{
          ...
          appraiserType:this.operailityData.appraiserType||'PART',        //评价对象类型 值为：所有人ALL、部分人PART、指定角色ROLE、科室DEPT
          appraiser:this.operailityData.appraiser,                //评价对象 根据 评价对象类型 所选不同，该项取值不同.
          appraiserPart:this.operailityData.appraiserPart||[],        //部分人PART评价对象 ，如：1000=张三,1000=张三 或 100=住院医,101=教学秘书 或 12=角色A,13=角色B
          appraiserRole:this.operailityData.appraiserRole||[],        //指定角色ROLE评价对象 ，如：1000=张三,1000=张三 或 100=住院医,101=教学秘书 或 12=角色A,13=角色B
          appraiserDept:this.operailityData.appraiserDept||[],        //科室DEPT评价对象(本部门或本科室) ，如：1000=张三,1000=张三 或 100=住院医,101=教学秘书 或 12=角色A,13=角色B
          evaluatedType:this.operailityData.evaluatedType||'PART',        //被评价人类型 ，值为：所有人ALL、部分人PART、指定角色ROLE、科室DEPT
          appraiserCount:this.operailityData.appraiserCount,      //评价人总数
          evaluated:this.operailityData.evaluated,                //被评对象 根据 被评对象类型 所选不同，该项取值不同.
          evaluatedPart:this.operailityData.evaluatedPart||[],        //部分人PART被评对象 ，，如：1000=张三,1000=张三 或 100=住院医,101=教学秘书 或 12=角色A,13=角色B
          evaluatedRole:this.operailityData.evaluatedRole||[],        //指定角色ROLE被评对象 ，，如：1000=张三,1000=张三 或 100=住院医,101=教学秘书 或 12=角色A,13=角色B
          evaluatedDept:this.operailityData.evaluatedDept||[],        //科室DEPT被评对象(本部门或本科室) ，，如：1000=张三,1000=张三 或 100=住院医,101=教学秘书 或 12=角色A,13=角色B
          evaluatedCount:this.operailityData.evaluatedCount,      //被评价人总数
          counts:this.operailityData.counts,                      //已评价人总数
        },
        //查询项
        /*--按钮button--*/
        //表格数据
...
//       更新基础数据
//       继续下一步
        if(!this.formValidate.appraiserType){
          this.errorMess('请选择评价人');
          return;
        }else if(!this.formValidate.evaluatedType){
