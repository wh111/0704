    ...
    <el-form ref="formValidate" :model="formValidate" class="demo-form-inline" label-width="110px">
      ...
      <el-row>
        <el-col :span="22" :offset="1">
          ...
          <!-- 住院医附加显示字段 -->
          <template v-if="studentType === 'ZYY'">
            <el-row :gutter="10" class="table-back-one">
              <el-col :span="11">
                <el-form-item label="人员属性：">
                  {{formValidate.rotaryZyytypeName}}
                </el-form-item>
              </el-col>
              <el-col :span="11">
                <el-form-item label="培训方向：">
                  {{formValidate.rotaryProclassName}}
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="10" class="table-back-one">
              <el-col :span="11">
                <el-form-item label="培训年限：">
                  {{formValidate.rotaryAdmrank}}
                </el-form-item>
              </el-col>
              <el-col :span="11">
                <el-form-item label="参培年份：">
                  {{formValidate.rotaryYear}}
                </el-form-item>
              </el-col>
            </el-row>
          </template>
          ...
          <el-row :gutter="10" class="table-back-one">
            ...
            <el-col :span="11">
              <el-form-item label="医师资格级别：" prop="doctorLevel">
                {{(formValidate.doctorLevel || '暂无') | qfcLevel}}
              </el-form-item>
            </el-col>
          </el-row>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        formValidate: {
          ...
          headPhotoHttp: "", //头像全地址
          // 住院医附加显示字段
          rotaryProclassName: '', // 专业
          rotaryZyytypeName: '', // 人员属性
          rotaryYear: '', // 参培年份
          rotaryAdmrank: '', // 培训年限
        },
    ...
    methods: {
       ...
       * */
      init() {
        if (this.studentType) { // 指定学生类型
          if (this.studentType === 'ZYY') { // 住院医
            this.initMessTitle.ajaxParams.url = '/user/getZYY/' + this.dataId
          }
        }
        //默认请求加载数据
